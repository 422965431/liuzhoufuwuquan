...
namespace CouponMall.Core
{
    ...
    public class CreditConfigInfo : IConfigInfo
    {
        ...
        private int _loginpaycredits;//每天登录支付积分
        ...
        private int _receiveorderpaycredits;//收货支付积分(以订单金额的百分比计算)
        ...
        private int _receiveorderrankcredits;//收货等级积分(以订单金额的百分比计算)
        ...
        /// 收货支付积分(以订单金额的百分比计算)
        /// </summary>
        public int ReceiveOrderPayCredits
        {
            get { return _receiveorderpaycredits; }
            set { _receiveorderpaycredits = value; }
        }
        /// <summary>
        /// 评价商品支付积分
        /// </summary>
        ...
        /// 收货等级积分(以订单金额的百分比计算)
        /// </summary>
        public int ReceiveOrderRankCredits
        {
            get { return _receiveorderrankcredits; }
            set { _receiveorderrankcredits = value; }
        }
        /// <summary>
        /// 评价商品等级积分
        /// </summary>
