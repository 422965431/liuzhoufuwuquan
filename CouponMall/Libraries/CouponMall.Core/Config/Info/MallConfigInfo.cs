...
namespace CouponMall.Core
{
    ...
    /// </summary>
    [Serializable]
    public class MallConfigInfo : IConfigInfo
    {
        #region 站点信息

        private string _mallname = "couponmall网上商城";//商城名称
        private string _siteurl = "http://www.ddd.com";//网站网址
        private string _sitetitle = "couponmall网上商城";//网站标题
        ...
        {
            get { return _favoriteproductcount; }
            set { _favoriteproductcount = value; }
        }
        /// <summary>
        /// 店铺收藏夹最大容量
        /// </summary>
        ...
        {
            get { return _favoritestorecount; }
            set { _favoritestorecount = value; }
        }
