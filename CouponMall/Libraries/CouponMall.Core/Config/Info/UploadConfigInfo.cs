...
namespace CouponMall.Core
{
    ...
    public class UploadConfigInfo : IConfigInfo
    {
        ...
        private string _storerankavatarthumbsize = "";//店铺等级头像缩略图大小
        private string _storelogothumbsize = "";//店铺logo缩略图大小
        ...
        /// 店铺等级头像缩略图大小
        /// </summary>
        public string StoreRankAvatarThumbSize
        {
            get { return _storerankavatarthumbsize; }
            set { _storerankavatarthumbsize = value; }
        }

        /// <summary>
        /// 店铺logo缩略图大小
        /// </summary>
        public string StoreLogoThumbSize
        {
            get { return _storelogothumbsize; }
            set { _storelogothumbsize = value; }
        }
    }
}
