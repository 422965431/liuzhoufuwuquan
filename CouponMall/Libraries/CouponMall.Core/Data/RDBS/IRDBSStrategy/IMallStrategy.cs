...
namespace CouponMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <returns></returns>
        DataTable GetProvinceRegionStat(int storeId);
        ...
        /// <returns></returns>
        DataTable GetCityRegionStat(int storeId, int provinceId);
        ...
        /// <returns></returns>
        DataTable GetCountyRegionStat(int storeId, int cityId);
        ...
        /// 创建商城管理日志
        /// </summary>
        void CreateMallAdminLog(MallAdminLogInfo mallAdminLogInfo);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        IDataReader GetMallAdminLogList(int pageSize, int pageNumber, string condition);
        ...
        /// <returns></returns>
        string GetMallAdminLogListCondition(int uid, string operation, string startTime, string endTime);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        int GetMallAdminLogCount(string condition);

        /// <summary>
        /// 删除商城管理日志
        /// </summary>
        /// <param name="idList">日志id</param>
        void DeleteMallAdminLogById(string idList);
        ...
        /// 创建店铺管理日志
        /// </summary>
        void CreateStoreAdminLog(StoreAdminLogInfo storeAdminLogInfo);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        IDataReader GetStoreAdminLogList(int pageSize, int pageNumber, string condition);
        ...
        /// <param name="endTime">操作结束时间</param>
        /// <returns></returns>
        string GetStoreAdminLogListCondition(int storeId, string operation, string startTime, string endTime);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        int GetStoreAdminLogCount(string condition);

        /// <summary>
        /// 删除店铺管理日志
        /// </summary>
        /// <param name="logIdList">日志id</param>
        void DeleteStoreAdminLogById(string logIdList);
