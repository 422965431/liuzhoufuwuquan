...
namespace CouponMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        void ApplyOrderAfterService(OrderAfterServiceState state, int uid, int oid, int recordId, int pid, int cateId, int brandId, int storeId, string pname, string pshowImg, int count, decimal money, int type, string applyReason, DateTime applyTime);
        ...
        /// <returns></returns>
        string GetOrderProductAfterServiceListCondition(int storeId, int uid, int oid, int state, int type, string applyStartTime, string applyEndTime);
