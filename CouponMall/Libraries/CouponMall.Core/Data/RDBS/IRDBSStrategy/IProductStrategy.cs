...
namespace CouponMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <returns></returns>
        string AdminGetProductListCondition(int storeId, int storeCid, string productName, int cateId, int brandId, int state);
        ...
        /// <param name="sortDirection">排序方向</param>
        /// <returns></returns>
        IDataReader GetStoreClassProductList(int pageSize, int pageNumber, int storeCid, int startPrice, int endPrice, int sortColumn, int sortDirection);
        ...
        /// <param name="endPrice">结束价格</param>
        /// <returns></returns>
        int GetStoreClassProductCount(int storeCid, int startPrice, int endPrice);
        ...
        /// <returns></returns>
        IDataReader GetStoreTraitProductList(int count, int storeId, int storeCid, int trait);
        ...
        /// <param name="storeCid">店铺分类id</param>
        /// <returns></returns>
        IDataReader GetStoreSaleProductList(int count, int storeId, int storeCid);
        ...
        /// <param name="pidList">商品id列表</param>
        /// <returns></returns>
        DataTable GetStoreIdListByPid(string pidList);
        ...
        /// <param name="storeId">店铺id</param>
        /// <returns></returns>
        int AdminGetStoreProductCount(int storeId);
        ...
        /// <param name="storeCid">店铺分类id</param>
        /// <returns></returns>
        int AdminGetStoreClassProductCount(int storeCid);
        ...
        /// <param name="productName">商品名称</param>
        /// <returns></returns>
        DataTable GetTimeProductList(int pageSize, int pageNumber, int storeId, string productName);
        ...
        /// <param name="productName">商品名称</param>
        /// <returns></returns>
        int GetTimeProductCount(int storeId, string productName);
        ...
        void ConsultProduct(int pid, int consultTypeId, int consultUid, int storeId, DateTime consultTime, string consultMessage, string consultNickName, string pName, string pShowImg, string consultIP);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        DataTable AdminGetProductConsultList(int pageSize, int pageNumber, string condition);
        ...
        /// <returns></returns>
        string AdminGetProductConsultListCondition(int consultTypeId, int storeId, int pid, int uid, string consultMessage, string consultStartTime, string consultEndTime);
        ...
        /// <returns></returns>
        DataTable GetStoreIdListByConsultId(string consultIdList);
        ...
        /// <returns></returns>
        string AdminGetProductReviewListCondition(int storeId, int pid, string message, string startTime, string endTime);
