...
namespace CouponMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        void DeleteSinglePromotionById(string pmIdList);
        ...
        /// <returns></returns>
        DataTable AdminGetSinglePromotionList(int pageSize, int pageNumber, string condition);
        ...
        /// <returns></returns>
        string AdminGetSinglePromotionListCondition(int storeId, int pid, string promotionName, string promotionTime);
        ...
        /// <returns></returns>
        DataTable GetStoreIdListBySinglePmId(string pmIdList);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        DataTable AdminGetBuySendPromotionList(int pageSize, int pageNumber, string condition);
        ...
        /// <param name="promotionTime">活动时间</param>
        /// <returns></returns>
        string AdminGetBuySendPromotionListCondition(int storeId, string promotionName, string promotionTime);
        ...
        /// <param name="nowTime">当前时间</param>
        /// <returns></returns>
        IDataReader GetBuySendPromotionList(int storeId, int pid, DateTime nowTime);
        ...
        /// <returns></returns>
        DataTable GetStoreIdListByBuySendPmId(string pmIdList);
        ...
        /// <param name="nowTime">当前时间</param>
        /// <returns></returns>
        IDataReader GetAllBuySendPromotion(int storeId, DateTime nowTime);
        ...
        /// <returns></returns>
        DataTable GetStoreIdListByBuySendProductRecordId(string recordIdList);
        ...
        void DeleteGiftPromotionById(string pmIdList);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        DataTable AdminGetGiftPromotionList(int pageSize, int pageNumber, string condition);
        ...
        /// <param name="promotionTime">活动时间</param>
        /// <returns></returns>
        string AdminGetGiftPromotionListCondition(int storeId, int pid, string promotionName, string promotionTime);
        ...
        /// <returns></returns>
        DataTable GetStoreIdListByGiftPmId(string pmIdList);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        DataTable AdminGetSuitPromotionList(int pageSize, int pageNumber, string condition);
        ...
        /// <param name="promotionTime">活动时间</param>
        /// <returns></returns>
        string AdminGetSuitPromotionListCondition(int storeId, int pid, string promotionName, string promotionTime);
        ...
        /// <returns></returns>
        DataTable GetStoreIdListBySuitPmId(string pmIdList);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        DataTable AdminGetFullSendPromotionList(int pageSize, int pageNumber, string condition);
        ...
        /// <param name="promotionTime">活动时间</param>
        /// <returns></returns>
        string AdminGetFullSendPromotionListCondition(int storeId, string promotionName, string promotionTime);
        ...
        /// <param name="nowTime">当前时间</param>
        /// <returns></returns>
        IDataReader GetFullSendPromotionByStoreIdAndPidAndTime(int storeId, int pid, DateTime nowTime);
        ...
        /// <returns></returns>
        DataTable GetStoreIdListByFullSendPmId(string pmIdList);
        ...
        /// <returns></returns>
        DataTable GetStoreIdListByFullSendProductRecordId(string recordIdList);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        DataTable AdminGetFullCutPromotionList(int pageSize, int pageNumber, string condition);
        ...
        /// <param name="promotionTime">活动时间</param>
        /// <returns></returns>
        string AdminGetFullCutPromotionListCondition(int storeId, string promotionName, string promotionTime);
        ...
        /// <param name="nowTime">当前时间</param>
        /// <returns></returns>
        IDataReader GetFullCutPromotionByStoreIdAndPidAndTime(int storeId, int pid, DateTime nowTime);
        ...
        /// <returns></returns>
        DataTable GetStoreIdListByFullCutPmId(string pmIdList);
        ...
        /// <param name="nowTime">当前时间</param>
        /// <returns></returns>
        IDataReader GetAllFullCutPromotion(int storeId, DateTime nowTime);
        ...
        /// <returns></returns>
        DataTable GetStoreIdListByFullCutProductRecordId(string recordIdList);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        DataTable AdminGetTopicList(int pageSize, int pageNumber, string condition);
        ...
        /// <returns></returns>
        string AdminGetCouponTypeListCondition(int storeId, int type, string couponTypeName);
        ...
        /// <param name="storeId">店铺id</param>
        /// <returns></returns>
        IDataReader GetSendingPromotionCouponTypeList(int storeId);
        ...
        /// <param name="nowTime">当前时间</param>
        /// <returns></returns>
        IDataReader GetSendingCouponTypeList(int storeId, DateTime nowTime);
        ...
        /// <param name="nowTime">当前时间</param>
        /// <returns></returns>
        IDataReader GetUsingCouponTypeList(int storeId, DateTime nowTime);
        ...
        /// <param name="couponTypeIdList">优惠劵类型id列表</param>
        /// <returns></returns>
        DataTable GetStoreIdListByCouponTypeId(string couponTypeIdList);
        ...
        /// <param name="couponTypeId">优惠劵类型id</param>
        /// <returns></returns>
        string AdminGetCouponListCondition(string sn, int uid, int couponTypeId);
        ...
        /// <returns></returns>
        DataTable GetStoreIdListByCouponId(string couponIdList);
        ...
        /// <returns></returns>
        DataTable GetStoreIdListByCouponProductRecordId(string recordIdList);
