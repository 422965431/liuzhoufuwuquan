...
namespace CouponMall.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <returns></returns>
        int GetUserCountByMallAGid(int mallAGid);
        ...
        void SetStoreAdminer(int uid, int storeId);
        ...
        /// <param name="storeId">店铺id</param>
        /// <returns></returns>
        int GetStoreAdminerIdByStoreId(int storeId);
        ...
        /// </summary>
        /// <returns></returns>
        DataTable GetMallAdminGroupList();
        ...
        /// <returns></returns>
        int CreateMallAdminGroup(MallAdminGroupInfo mallAdminGroupInfo);

        /// <summary>
        /// 删除商城管理员组
        /// </summary>
        /// <param name="mallAGid">商城管理员组id</param>
        void DeleteMallAdminGroupById(int mallAGid);

        /// <summary>
        /// 更新商城管理员组
        /// </summary>
        void UpdateMallAdminGroup(MallAdminGroupInfo mallAdminGroupInfo);
        ...
        /// </summary>
        /// <returns></returns>
        IDataReader GetMallAdminActionList();
        ...
        /// </summary>
        /// <returns></returns>
        bool AddProductToFavorite(int uid, int pid, int state, DateTime addTime);
        ...
        /// <returns></returns>
        DataTable GetFavoriteProductList(int pageSize, int pageNumber, int uid, string storeName, string productName);
        ...
        /// <param name="productName">商品名称</param>
        /// <returns></returns>
        int GetFavoriteProductCount(int uid, string storeName, string productName);
        ...
        /// <returns></returns>
        bool AddStoreToFavorite(int uid, int storeId, DateTime addTime);
        ...
        /// <param name="storeId">店铺id</param>
        /// <returns></returns>
        bool DeleteFavoriteStoreByUidAndStoreId(int uid, int storeId);
        ...
        /// <param name="storeId">店铺id</param>
        /// <returns></returns>
        bool IsExistFavoriteStore(int uid, int storeId);
        ...
        /// <param name="uid">用户id</param>
        /// <returns></returns>
        DataTable GetFavoriteStoreList(int pageSize, int pageNumber, int uid);
        ...
        /// <param name="uid">用户id</param>
        /// <returns></returns>
        int GetFavoriteStoreCount(int uid);
