...
namespace CouponMall.Data
{
    ...
    public partial class Adverts
    {
        ...
        public static List<AdvertPositionInfo> GetAdvertPositionList(int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAdvertPositionList(pageSize, pageNumber);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetAdvertPositionCount();
        }
        ...
        {
            List<AdvertPositionInfo> advertPositionList = new List<AdvertPositionInfo>();
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAllAdvertPosition();
            while (reader.Read())
            {
                AdvertPositionInfo advertPositionInfo = BuildAdvertPositionFromReader(reader);
                advertPositionList.Add(advertPositionInfo);
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateAdvertPosition(advertPositionInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateAdvertPosition(advertPositionInfo);
        }
        ...
        public static AdvertPositionInfo GetAdvertPositionById(int adPosId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAdvertPositionById(adPosId);
            if (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteAdvertPositionById(adPosId);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateAdvert(advertInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateAdvert(advertInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteAdvertById(adId);
        }
        ...
        public static AdvertInfo AdminGetAdvertById(int adId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetAdvertById(adId);
            if (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetAdvertList(pageSize, pageNumber, adPosId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetAdvertCount(adPosId);
        }
        ...
        public static List<AdvertInfo> GetAdvertList(int adPosId, DateTime nowTime)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAdvertList(adPosId, nowTime);
            while (reader.Read())
            {
