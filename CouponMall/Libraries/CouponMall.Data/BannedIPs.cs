...
namespace CouponMall.Data
{
    ...
    public partial class BannedIPs
    {
        ...
        public static HashSet<string> GetBannedIPList()
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetBannedIPList();
            while (reader.Read())
            {
        ...
        public static BannedIPInfo GetBannedIPById(int id)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetBannedIPById(id);
            if (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetBannedIPIdByIP(ip);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.AddBannedIP(bannedIPInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateBannedIP(bannedIPInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteBannedIPById(idList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetBannedIPList(pageSize, pageNumber, ip);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetBannedIPCount(ip);
        }
    }
}
