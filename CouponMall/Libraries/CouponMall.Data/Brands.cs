...
namespace CouponMall.Data
{
    ...
    public partial class Brands
    {
        ...
        public static BrandInfo GetBrandById(int brandId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetBrandById(brandId);
            if (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateBrand(brandInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateBrand(brandInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteBrandById(brandId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetBrandListCondition(brandName);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetBrandList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetBrandSelectList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetBrandCount(condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetBrandIdByName(brandName);
        }
        ...
        public static List<BrandInfo> GetBrandList(int pageSize, int pageNumber, string brandName)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetBrandList(pageSize, pageNumber, brandName);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetBrandCount(brandName);
        }
    }
}
