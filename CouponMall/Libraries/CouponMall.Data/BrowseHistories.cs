...
namespace CouponMall.Data
{
    ...
    public partial class BrowseHistories
    {
        ...
        public static List<PartProductInfo> GetUserBrowseProductList(int pageSize, int pageNumber, int uid)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetUserBrowseProductList(pageSize, pageNumber, uid);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetUserBrowseProductCount(uid);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateBrowseHistory(uid, pid, updateTime);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.ClearExpiredBrowseHistory();
        }
    }
}
