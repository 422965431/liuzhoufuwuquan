...
namespace CouponMall.Data
{
    ...
    public partial class Categories
    {
        ...
        public static List<CategoryInfo> GetCategoryList()
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetCategoryList();
            while (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateCategory(categoryInfo);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.CreateCategory(categoryInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteCategoryById(cateId);
        }
        ...
        public static List<BrandInfo> GetCategoryBrandList(int cateId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetCategoryBrandList(cateId);
            while (reader.Read())
            {
        ...
        public static List<AttributeGroupInfo> GetAttributeGroupListByCateId(int cateId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAttributeGroupListByCateId(cateId);
            while (reader.Read())
            {
        ...
        public static AttributeGroupInfo GetAttributeGroupById(int attrGroupId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAttributeGroupById(attrGroupId);
            if (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateAttributeGroup(attributeGroupInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateAttributeGroup(attributeGroupInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteAttributeGroupById(attrGroupId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetAttrGroupIdByCateIdAndName(cateId, name);
        }
        ...
        public static List<AttributeInfo> GetAttributeListByCateId(int cateId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAttributeListByCateId(cateId);
            while (reader.Read())
            {
        ...
        {
            List<AttributeInfo> attributeList = new List<AttributeInfo>();
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAttributeListByAttrGroupId(attrGroupId);
            while (reader.Read())
            {
                AttributeInfo attributeInfo = BuildAttributeFromReader(reader);
                attributeList.Add(attributeInfo);
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetAttributeList(cateId);
        }
        ...
        {
            List<AttributeInfo> attributeList = new List<AttributeInfo>();
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetFilterAttributeListByCateId(cateId);
            while (reader.Read())
            {
                AttributeInfo attributeInfo = BuildAttributeFromReader(reader);
                attributeList.Add(attributeInfo);
        ...
        public static AttributeInfo GetAttributeById(int attrId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAttributeById(attrId);
            if (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateAttribute(attributeInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateAttribute(attributeInfo, attrGroupId, attrGroupName, attrGroupDisplayOrder);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteAttributeById(attrId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetAttrIdByCateIdAndName(cateId, attributeName);
        }
        ...
        public static List<AttributeValueInfo> GetAttributeValueListByAttrId(int attrId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAttributeValueListByAttrId(attrId);
            while (reader.Read())
            {
        ...
        public static AttributeValueInfo GetAttributeValueById(int attrValueId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAttributeValueById(attrValueId);
            if (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateAttributeValue(attributeValueInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteAttributeValueById(attrValueId);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateAttributeValue(attributeValueInfo);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetAttributeValueIdByAttrIdAndValue(attrId, attrValue);
        }
    }
}
