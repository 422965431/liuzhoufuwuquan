...
namespace CouponMall.Data
{
    ...
    public partial class Coupons
    {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateCouponType(couponTypeInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteCouponTypeById(couponTypeIdList);
        }
        ...
        public static CouponTypeInfo GetCouponTypeById(int couponTypeId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetCouponTypeById(couponTypeId);
            if (reader.Read())
            {
        ...
        {
            CouponTypeInfo couponTypeInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetCouponTypeById(couponTypeId);
            if (reader.Read())
            {
                couponTypeInfo = BuildCouponTypeFromReader(reader);
            }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetCouponTypeListCondition(storeId, type, couponTypeName);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetCouponTypeList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetCouponTypeCount(condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.ChangeCouponTypeState(couponTypeId, state);
        }
        ...
        public static List<CouponTypeInfo> GetSendingPromotionCouponTypeList(int storeId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetSendingPromotionCouponTypeList(storeId);
            while (reader.Read())
            {
        ...
        {
            List<CouponTypeInfo> couponTypeList = new List<CouponTypeInfo>();
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetSendingCouponTypeList(storeId, nowTime);
            while (reader.Read())
            {
                CouponTypeInfo couponTypeInfo = BuildCouponTypeFromReader(reader);
                couponTypeList.Add(couponTypeInfo);
        ...
        {
            List<CouponTypeInfo> couponTypeList = new List<CouponTypeInfo>();
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetUsingCouponTypeList(storeId, nowTime);
            while (reader.Read())
            {
                CouponTypeInfo couponTypeInfo = BuildCouponTypeFromReader(reader);
                couponTypeList.Add(couponTypeInfo);
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdListByCouponTypeId(couponTypeIdList);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateCoupon(couponInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteCouponById(idList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetCouponListCondition(sn, uid, couponTypeId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetCouponList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetCouponCount(condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsExistCouponSN(couponSN);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetSendCouponCount(couponTypeId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetSendUserCouponCount(uid, couponTypeId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetTodaySendUserCouponCount(uid, couponTypeId, today);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetCouponList(uid, type);
        }
        ...
        public static CouponInfo GetCouponByCouponId(int couponId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetCouponByCouponId(couponId);
            if (reader.Read())
            {
        ...
        {
            CouponInfo couponInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetCouponByCouponSN(couponSN);
            if (reader.Read())
            {
                couponInfo = BuildCouponFromReader(reader);
            }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UseCoupon(couponId, oid, time, ip);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.ActivateAndUseCoupon(couponId, uid, oid, time, ip);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.ActivateCoupon(couponId, uid, time, ip);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.ReturnUserOrderUseCoupons(oid);
        }
        ...
        public static List<CouponInfo> GetUserOrderSendCouponList(int oid)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetUserOrderSendCouponList(oid);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdListByCouponId(couponIdList);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.AddCouponProduct(couponTypeId, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.DeleteCouponProductByRecordId(recordIdList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsExistCouponProduct(couponTypeId, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetCouponProductList(pageSize, pageNumber, couponTypeId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetCouponProductCount(couponTypeId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsSameCouponType(couponTypeId, pidList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdListByCouponProductRecordId(recordIdList);
        }
    }
}
