...
namespace CouponMall.Data
{
    ...
    public partial class Credits
    {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetCreditLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetCreditLogListCondition(uid, startTime, endTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetCreditLogCount(condition);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.SendCredits(userRid, creditLogInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.SendPayCredits(creditLogInfo);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetTodaySendPayCredits(uid, today);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetTodaySendRankCredits(uid, today);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsSendTodayLoginCredit(uid, today);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsSendCompleteUserInfoCredit(uid);
        }
        ...
        public static List<CreditLogInfo> GetPayCreditLogList(int uid, int type, int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetPayCreditLogList(uid, type, pageSize, pageNumber);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetPayCreditLogCount(uid, type);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetUserOrderSendCredits(oid);
        }
    }
}
