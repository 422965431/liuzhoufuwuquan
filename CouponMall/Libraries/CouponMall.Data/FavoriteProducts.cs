...
namespace CouponMall.Data
{
    ...
    public partial class FavoriteProducts
    {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AddProductToFavorite(uid, pid, state, addTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.DeleteFavoriteProductByUidAndPid(uid, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsExistFavoriteProduct(uid, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetFavoriteProductList(pageSize, pageNumber, uid, storeName, productName);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetFavoriteProductList(pageSize, pageNumber, uid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetFavoriteProductCount(uid, storeName, productName);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetFavoriteProductCount(uid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.SetFavoriteProductState(uid, pid, state);
        }
    }
}
