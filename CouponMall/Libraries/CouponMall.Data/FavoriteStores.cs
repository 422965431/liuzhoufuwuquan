...
namespace CouponMall.Data
{
    ...
    public partial class FavoriteStores
    {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AddStoreToFavorite(uid, storeId, addTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.DeleteFavoriteStoreByUidAndStoreId(uid, storeId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsExistFavoriteStore(uid, storeId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetFavoriteStoreList(pageSize, pageNumber, uid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetFavoriteStoreCount(uid);
        }
    }
}
