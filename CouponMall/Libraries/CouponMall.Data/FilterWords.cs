...
namespace CouponMall.Data
{
    ...
    public partial class FilterWords
    {
        ...
        public static List<FilterWordInfo> GetFilterWordList()
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetFilterWordList();
            while (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.AddFilterWord(filterWordInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateFilterWord(filterWordInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteFilterWordById(idList);
        }
    }
}
