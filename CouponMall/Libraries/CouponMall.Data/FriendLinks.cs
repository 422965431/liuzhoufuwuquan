...
namespace CouponMall.Data
{
    ...
    public partial class FriendLinks
    {
        ...
        {
            DataTable dt = CouponMall.Core.BMAData.RDBS.GetFriendLinkList();
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateFriendLink(friendLinkInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteFriendLinkById(idList);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateFriendLink(friendLinkInfo);
        }
    }
}
