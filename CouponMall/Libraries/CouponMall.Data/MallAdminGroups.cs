...
namespace CouponMall.Data
{
    ...
    public partial class MallAdminGroups
    {
        ...
        {
            DataTable dt = CouponMall.Core.BMAData.RDBS.GetMallAdminGroupList();
        ...
        {
            return CouponMall.Core.BMAData.RDBS.CreateMallAdminGroup(mallAdminGroupInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteMallAdminGroupById(mallAGid);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateMallAdminGroup(mallAdminGroupInfo);
        }
    }
}
