...
namespace CouponMall.Data
{
    ...
    public partial class MallAdminLogs
    {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateMallAdminLog(mallAdminLogInfo);
        }
        ...
        public static List<MallAdminLogInfo> GetMallAdminLogList(int pageSize, int pageNumber, string condition)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetMallAdminLogList(pageSize, pageNumber, condition);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetMallAdminLogListCondition(uid, operation, startTime, endTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetMallAdminLogCount(condition);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteMallAdminLogById(logIdList);
        }
