...
namespace CouponMall.Data
{
    ...
    public partial class Navs
    {
        ...
        public static List<NavInfo> GetNavList()
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetNavList();
            while (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateNav(navInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteNavById(id);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateNav(navInfo);
        }
    }
}
