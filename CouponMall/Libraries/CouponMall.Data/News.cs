...
namespace CouponMall.Data
{
    ...
    public partial class News
    {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateNewsType(newsTypeInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteNewsTypeById(newsTypeId);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateNewsType(newsTypeInfo);
        }
        ...
        public static List<NewsTypeInfo> GetNewsTypeList()
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetNewsTypeList();
            while (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateNews(newsInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteNewsById(newsIdList);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateNews(newsInfo);
        }
        ...
        public static NewsInfo GetNewsById(int newsId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetNewsById(newsId);
            if (reader.Read())
            {
        ...
        {
            NewsInfo newsInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetNewsById(newsId);
            if (reader.Read())
            {
                newsInfo = BuildNewsFromReader(reader);
            }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetNewsList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetNewsListCondition(newsTypeId, title);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetNewsCount(condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetNewsIdByTitle(title);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetHomeNewsList(newsTypeId, count);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetNewsListCondition(newsTypeId, title);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetNewsList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetNewsCount(condition);
        }
    }
}
