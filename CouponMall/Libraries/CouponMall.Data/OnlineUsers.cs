...
namespace CouponMall.Data
{
    ...
    public partial class OnlineUsers
    {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.CreateOnlineUser(onlineUserInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateOnlineUserIP(olId, ip);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateOnlineUserUid(olId, uid);
        }
        ...
        public static OnlineUserInfo GetOnlineUserBySid(string sid)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetOnlineUserBySid(sid);
            if (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetOnlineUserCount(userType);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteOnlineUserBySid(sid);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteExpiredOnlineUser(onlineUserExpire);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.ResetOnlineUserTable();
        }
        ...
        public static List<OnlineUserInfo> GetOnlineUserList(int pageSize, int pageNumber, int locationType, int locationId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetOnlineUserList(pageSize, pageNumber, locationType, locationId);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetOnlineUserCount(locationType, locationId);
        }
    }
}
