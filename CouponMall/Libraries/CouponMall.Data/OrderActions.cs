...
namespace CouponMall.Data
{
    ...
    public partial class OrderActions
    {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateOrderAction(orderActionInfo);
            if (_ordernosql != null)
        ...
        public static List<OrderActionInfo> GetOrderActionList(int oid)
        {
            ...
            if (_ordernosql != null)
            {
                ...
                if (orderActionList == null)
                {
                    ...
                    IDataReader reader = CouponMall.Core.BMAData.RDBS.GetOrderActionList(oid);
                    while (reader.Read())
                    {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetOrderIdList(startTime, endTime, orderActionType);
        }
    }
}
