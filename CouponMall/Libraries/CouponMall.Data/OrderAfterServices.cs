...
namespace CouponMall.Data
{
    ...
    public partial class OrderAfterServices
    {
        ...
        public static void ApplyOrderAfterService(OrderAfterServiceState state, int uid, int oid, int recordId, int pid, int cateId, int brandId, int storeId, string pname, string pshowImg, int count, decimal money, int type, string applyReason, DateTime applyTime)
        {
            CouponMall.Core.BMAData.RDBS.ApplyOrderAfterService(state, uid, oid, recordId, pid, cateId, brandId, storeId, pname, pshowImg, count, money, type, applyReason, applyTime);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.CheckOrderAfterService(asId, state, checkResult, checkTime);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.SendOrderAfterService(asId, state, shipCoId, shipCoName, shipSN, regionId, consignee, mobile, phone, email, zipCode, address, sendTime);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.ReceiveOrderAfterService(asId, state, receiveTime);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.BackOrderAfterService(asId, state, shipCoId, shipCoName, shipSN, backTime);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.CompleteOrderAfterService(asId, state);
        }
        ...
        public static List<OrderAfterServiceInfo> GetOrderAfterServiceList(int oid)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetOrderAfterServiceList(oid);
            while (reader.Read())
            {
        ...
        {
            List<OrderAfterServiceInfo> orderAfterServiceList = new List<OrderAfterServiceInfo>();
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetOrderProductAfterServiceList(recordId);
            while (reader.Read())
            {
                OrderAfterServiceInfo orderAfterServiceInfo = BuildOrderAfterServiceFromReader(reader);
                orderAfterServiceList.Add(orderAfterServiceInfo);
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetOrderProductAfterServiceList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetOrderProductAfterServiceCount(condition);
        }
        ...
        /// <returns></returns>
        public static string GetOrderProductAfterServiceListCondition(int storeId, int uid, int oid, int state, int type, string applyStartTime, string applyEndTime)
        {
            return CouponMall.Core.BMAData.RDBS.GetOrderProductAfterServiceListCondition(storeId, uid, oid, state, type, applyStartTime, applyEndTime);
        }
        ...
        public static OrderAfterServiceInfo GetOrderAfterServiceByASId(int asId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetOrderAfterServiceByASId(asId);
            if (reader.Read())
            {
