...
namespace CouponMall.Data
{
    ...
    public partial class OrderRefunds
    {
        ...
        {
            CouponMall.Core.BMAData.RDBS.ApplyRefund(orderRefundInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.RefundOrder(refundId, state, refundSN, refundTime);
        }
        ...
        public static List<OrderRefundInfo> GetOrderRefundList(int pageSize, int pageNumber, string condition)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetOrderRefundList(pageSize, pageNumber, condition);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetOrderRefundListCondition(storeId, osn);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetOrderRefundCount(condition);
        }
    }
}
