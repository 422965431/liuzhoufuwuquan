    ...
    public partial class Orders
    {
        ...
        public static OrderInfo GetOrderByOid(int oid)
        {
            ...
            if (_ordernosql != null)
            {
                ...
                if (orderInfo == null)
                {
                    IDataReader reader = CouponMall.Core.BMAData.RDBS.GetOrderByOid(oid);
                    if (reader.Read())
                    {
        ...
        {
            OrderInfo orderInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetOrderByOSN(osn);
            if (reader.Read())
            {
                orderInfo = BuildOrderFromReader(reader);
            }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetOrderCountByCondition(storeId, orderState, startTime, endTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetOrderList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetOrderListCondition(storeId, osn, uid, consignee, orderState);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetOrderCount(condition);
        }
        ...
        public static List<OrderProductInfo> GetOrderProductList(int oid)
        {
            ...
            if (_ordernosql != null)
            {
                ...
                if (orderProductList == null)
                {
                    ...
                    IDataReader reader = CouponMall.Core.BMAData.RDBS.GetOrderProductList(oid);
                    while (reader.Read())
                    {
        ...
        public static List<OrderProductInfo> GetOrderProductList(string oidList)
        {
            ...
            {
                IDataReader reader = CouponMall.Core.BMAData.RDBS.GetOrderProductList(oidList);
                while (reader.Read())
                {
                    OrderProductInfo orderProductInfo = BuildOrderProductFromReader(reader);
                    orderProductList.Add(orderProductInfo);
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateOrderDiscount(oid, discount, surplusMoney);
            if (_ordernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateOrderShipFee(oid, shipFee, orderAmount, surplusMoney);
            if (_ordernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateOrderState(oid, orderState);
            if (_ordernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.SendOrderProduct(oid, orderState, shipSN, shipCoId, shipCoName, shipTime);
            if (_ordernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.PayOrder(oid, orderState, paySN, paySystemName, payFriendName, payTime);
            if (_ordernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateOrderIsReview(oid, isReview);
            if (_ordernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.ClearExpiredOnlinePayOrder(expireTime);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.AutoReceiveOrder(expireTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetUserOrderList(uid, pageSize, pageNumber, startAddTime, endAddTime, orderState);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetUserOrderCount(uid, startAddTime, endAddTime, orderState);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetUserUnReviewOrderList(uid, pageSize, pageNumber, startAddTime, endAddTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetUserUnReviewOrderCount(uid, startAddTime, endAddTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetSaleProductList(pageSize, pageNumber, storeId, startTime, endTime, orderState);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetSaleProductCount(storeId, startTime, endTime, orderState);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetOrderStat(statType, storeId, startTime, endTime);
        }
    }
}