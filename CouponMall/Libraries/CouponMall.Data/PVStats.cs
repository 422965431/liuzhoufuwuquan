...
namespace CouponMall.Data
{
    ...
    public partial class PVStats
    {
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdatePVStat(updatePVStatState);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetProvinceRegionStat(storeId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetCityRegionStat(storeId, provinceId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetCountyRegionStat(storeId, cityId);
        }
        ...
        public static List<PVStatInfo> GetPVStatList(string condition)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetPVStatList(condition);
            while (reader.Read())
            {
        ...
        public static PVStatInfo GetPVStatByCategoryAndValue(string category, string value)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetPVStatByCategoryAndValue(category, value);
            if (reader.Read())
            {
