...
namespace CouponMall.Data
{
    ...
    public partial class ProductConsults
    {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateProductConsultType(productConsultTypeInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateProductConsultType(productConsultTypeInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteProductConsultTypeById(consultTypeId);
        }
        ...
        {
            DataTable dt = CouponMall.Core.BMAData.RDBS.GetProductConsultTypeList();
        ...
        {
            CouponMall.Core.BMAData.RDBS.ConsultProduct(pid, consultTypeId, consultUid, storeId, consultTime, consultMessage, consultNickName, pName, pShowImg, consultIP);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.ReplyProductConsult(consultId, replyUid, replyTime, replyMessage, replyNickName, replyIP);
        }
        ...
        public static ProductConsultInfo GetProductConsultById(int consultId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetProductConsultById(consultId);
            if (reader.Read())
            {
        ...
        {
            ProductConsultInfo productConsultInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetProductConsultById(consultId);
            if (reader.Read())
            {
                productConsultInfo = BuildProductConsultFromReader(reader);
            }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteProductConsultById(consultIdList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetProductConsultList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetProductConsultListCondition(consultTypeId, storeId, pid, uid, consultMessage, consultStartTime, consultEndTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetProductConsultCount(condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.UpdateProductConsultState(consultId, state);
        }
        ...
        public static List<ProductConsultInfo> GetProductConsultList(int pageSize, int pageNumber, int pid, int consultTypeId, string consultMessage)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetProductConsultList(pageSize, pageNumber, pid, consultTypeId, consultMessage);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetProductConsultCount(pid, consultTypeId, consultMessage);
        }
        ...
        public static List<ProductConsultInfo> GetUserProductConsultList(int uid, int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetUserProductConsultList(uid, pageSize, pageNumber);
            while (reader.Read())
            {
                ProductConsultInfo productConsultInfo = BuildProductConsultFromReader(reader);
                productConsultList.Add(productConsultInfo);
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetUserProductConsultCount(uid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdListByConsultId(consultIdList);
        }
    }
}
