...
namespace CouponMall.Data
{
    ...
    public partial class ProductReviews
    {
        ...
        public static ProductReviewInfo GetProductReviewById(int reviewId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetProductReviewById(reviewId);
            if (reader.Read())
            {
        ...
        {
            ProductReviewInfo productReviewInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetProductReviewById(reviewId);
            if (reader.Read())
            {
                productReviewInfo = BuildProductReviewFromReader(reader);
            }
        ...
        {
            CouponMall.Core.BMAData.RDBS.ReviewProduct(productReviewInfo);
            if (_ordernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteProductReviewById(reviewId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetProductReviewList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetProductReviewListCondition(storeId, pid, message, startTime, endTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetProductReviewCount(condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetProductReviewReplyList(reviewId);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.VoteProductReview(reviewId, uid, voteTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsVoteProductReview(reviewId, uid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.ChangeProductReviewState(reviewId, state);
        }
        ...
        public static List<ProductReviewInfo> GetUserProductReviewList(int uid, int pageSize, int pageNumber)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetUserProductReviewList(uid, pageSize, pageNumber);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetUserProductReviewCount(uid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetProductReviewList(pid, type, pageSize, pageNumber);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetProductReviewCount(pid, type);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetProductReviewWithReplyById(reviewId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetProductReviewList(startTime, endTime);
        }
    }
}
