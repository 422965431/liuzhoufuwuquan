...
namespace CouponMall.Data
{
    ...
    public partial class Promotions
    {
        ...
        public static SinglePromotionInfo AdminGetSinglePromotionById(int pmId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetSinglePromotionById(pmId);
            if (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateSinglePromotion(singlePromotionInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateSinglePromotion(singlePromotionInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteSinglePromotionById(pmIdList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetSinglePromotionList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetSinglePromotionListCondition(storeId, pid, promotionName, promotionTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetSinglePromotionCount(condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminIsExistSinglePromotion(pid, startTime, endTime);
        }
        ...
        {
            SinglePromotionInfo singlePromotionInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetSinglePromotionByPidAndTime(pid, nowTime);
            if (reader.Read())
            {
                singlePromotionInfo = BuildSinglePromotionFromReader(reader);
            }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetSinglePromotionProductBuyCount(uid, pmId);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateSinglePromotionStock(singlePromotionList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdListBySinglePmId(pmIdList);
        }
        ...
        public static List<string> GetSinglePromotionPidList(string pmIdList)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetSinglePromotionPidList(pmIdList);
            while (reader.Read())
            {
        ...
        public static BuySendPromotionInfo AdminGetBuySendPromotionById(int pmId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetBuySendPromotionById(pmId);
            if (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateBuySendPromotion(buySendPromotionInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateBuySendPromotion(buySendPromotionInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteBuySendPromotionById(pmIdList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetBuySendPromotionList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetBuySendPromotionListCondition(storeId, promotionName, promotionTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetBuySendPromotionCount(condition);
        }
        ...
        public static List<BuySendPromotionInfo> GetBuySendPromotionList(int storeId, int pid, DateTime nowTime)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetBuySendPromotionList(storeId, pid, nowTime);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdListByBuySendPmId(pmIdList);
        }
        ...
        public static List<BuySendPromotionInfo> GetAllBuySendPromotion(int storeId, DateTime nowTime)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAllBuySendPromotion(storeId, nowTime);
            while (reader.Read())
            {
                BuySendPromotionInfo buySendPromotionInfo = BuildBuySendPromotionFromReader(reader);
        ...
        {
            CouponMall.Core.BMAData.RDBS.AddBuySendProduct(pmId, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.DeleteBuySendProductByRecordId(recordIdList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsExistBuySendProduct(pmId, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetBuySendProductList(pageSize, pageNumber, pmId, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetBuySendProductCount(pmId, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdListByBuySendProductRecordId(recordIdList);
        }
        ...
        public static List<string> GetBuySendPidList(string recordIdList)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetBuySendPidList(recordIdList);
            while (reader.Read())
            {
        ...
        public static GiftPromotionInfo AdminGetGiftPromotionById(int pmId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetGiftPromotionById(pmId);
            if (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateGiftPromotion(giftPromotionInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateGiftPromotion(giftPromotionInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteGiftPromotionById(pmIdList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetGiftPromotionList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetGiftPromotionListCondition(storeId, pid, promotionName, promotionTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetGiftPromotionCount(condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminIsExistGiftPromotion(pid, startTime, endTime);
        }
        ...
        {
            GiftPromotionInfo giftPromotionInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetGiftPromotionByPidAndTime(pid, nowTime);
            if (reader.Read())
            {
                giftPromotionInfo = BuildGiftPromotionFromReader(reader);
            }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdListByGiftPmId(pmIdList);
        }
        ...
        public static List<string> GetGiftPromotionPidList(string pmIdList)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetGiftPromotionPidList(pmIdList);
            while (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.AddGift(pmId, giftId, number, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.DeleteGiftByPmIdAndGiftId(pmId, giftId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsExistGift(pmId, giftId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.UpdateGiftNumber(pmId, giftId, number);
        }
        ...
        public static List<ExtGiftInfo> AdminGetExtGiftList(int pmId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetExtGiftList(pmId);
            while (reader.Read())
            {
        ...
        {
            List<ExtGiftInfo> extGiftList = new List<ExtGiftInfo>();
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetExtGiftList(pmId);
            while (reader.Read())
            {
                ExtGiftInfo extGiftInfo = BuildExtGiftFromReader(reader);
                extGiftList.Add(extGiftInfo);
        ...
        public static SuitPromotionInfo AdminGetSuitPromotionById(int pmId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetSuitPromotionById(pmId);
            if (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.CreateSuitPromotion(suitPromotionInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateSuitPromotion(suitPromotionInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteSuitPromotionById(pmIdList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetSuitPromotionList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetSuitPromotionListCondition(storeId, pid, promotionName, promotionTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetSuitPromotionCount(condition);
        }
        ...
        {
            SuitPromotionInfo suitPromotionInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetSuitPromotionByPmIdAndTime(pmId, nowTime);
            if (reader.Read())
            {
                suitPromotionInfo = BuildSuitPromotionFromReader(reader);
            }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsJoinSuitPromotion(uid, pmId);
        }
        ...
        public static List<SuitPromotionInfo> GetSuitPromotionList(int pid, DateTime nowTime)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetSuitPromotionList(pid, nowTime);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdListBySuitPmId(pmIdList);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.AddSuitProduct(pmId, pid, discount, number);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.DeleteSuitProductByPmIdAndPid(pmId, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsExistSuitProduct(pmId, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.UpdateSuitProductNumber(pmId, pid, number);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.UpdateSuitProductDiscount(pmId, pid, discount);
        }
        ...
        public static List<ExtSuitProductInfo> AdminGetExtSuitProductList(int pmId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetExtSuitProductList(pmId);
            while (reader.Read())
            {
        ...
        {
            List<ExtSuitProductInfo> extSuitProductList = new List<ExtSuitProductInfo>();
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetExtSuitProductList(pmId);
            while (reader.Read())
            {
                ExtSuitProductInfo extSuitProductInfo = BuildExtSuitProductFromReader(reader);
                extSuitProductList.Add(extSuitProductInfo);
        ...
        {
            List<ExtSuitProductInfo> extSuitProductList = new List<ExtSuitProductInfo>();
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetAllExtSuitProductList(pmIdList);
            while (reader.Read())
            {
                ExtSuitProductInfo extSuitProductInfo = BuildExtSuitProductFromReader(reader);
                extSuitProductList.Add(extSuitProductInfo);
        ...
        public static List<ExtSuitProductInfo> GetAllExtSuitProductList(string pmIdList)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAllExtSuitProductList(pmIdList);
            while (reader.Read())
            {
                ExtSuitProductInfo extSuitProductInfo = BuildExtSuitProductFromReader(reader);
                extSuitProductList.Add(extSuitProductInfo);
        ...
        public static FullSendPromotionInfo AdminGetFullSendPromotionById(int pmId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetFullSendPromotionById(pmId);
            if (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateFullSendPromotion(fullSendPromotionInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateFullSendPromotion(fullSendPromotionInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteFullSendPromotionById(pmIdList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetFullSendPromotionList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetFullSendPromotionListCondition(storeId, promotionName, promotionTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetFullSendPromotionCount(condition);
        }
        ...
        {
            FullSendPromotionInfo fullSendPromotionInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetFullSendPromotionByStoreIdAndPidAndTime(storeId, pid, nowTime);
            if (reader.Read())
            {
                fullSendPromotionInfo = BuildFullSendPromotionFromReader(reader);
            }
        ...
        {
            FullSendPromotionInfo fullSendPromotionInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetFullSendPromotionByPmIdAndTime(pmId, nowTime);
            if (reader.Read())
            {
                fullSendPromotionInfo = BuildFullSendPromotionFromReader(reader);
            }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdListByFullSendPmId(pmIdList);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.AddFullSendProduct(pmId, pid, type);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.DeleteFullSendProductByRecordId(recordIdList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsExistFullSendProduct(pmId, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetFullSendProductList(pageSize, pageNumber, pmId, type);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetFullSendProductCount(pmId, type);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsExistFullSendProduct(pmId, pid, type);
        }
        ...
        public static List<StoreProductInfo> GetFullSendMainProductList(int pageSize, int pageNumber, int pmId, int startPrice, int endPrice, int sortColumn, int sortDirection)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetFullSendMainProductList(pageSize, pageNumber, pmId, startPrice, endPrice, sortColumn, sortDirection);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetFullSendMainProductCount(pmId, startPrice, endPrice);
        }
        ...
        public static List<PartProductInfo> GetFullSendPresentList(int pmId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetFullSendPresentList(pmId);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdListByFullSendProductRecordId(recordIdList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetFullSendProductList(recordIdList);
        }
        ...
        public static FullCutPromotionInfo AdminGetFullCutPromotionById(int pmId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetFullCutPromotionById(pmId);
            if (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateFullCutPromotion(fullCutPromotionInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateFullCutPromotion(fullCutPromotionInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteFullCutPromotionById(pmIdList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetFullCutPromotionList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetFullCutPromotionListCondition(storeId, promotionName, promotionTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetFullCutPromotionCount(condition);
        }
        ...
        {
            FullCutPromotionInfo fullCutPromotionInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetFullCutPromotionByStoreIdAndPidAndTime(storeId, pid, nowTime);
            if (reader.Read())
            {
                fullCutPromotionInfo = BuildFullCutPromotionFromReader(reader);
            }
        ...
        {
            FullCutPromotionInfo fullCutPromotionInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetFullCutPromotionByPmIdAndTime(pmId, nowTime);
            if (reader.Read())
            {
                fullCutPromotionInfo = BuildFullCutPromotionFromReader(reader);
            }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdListByFullCutPmId(pmIdList);
        }
        ...
        public static List<FullCutPromotionInfo> GetAllFullCutPromotion(int storeId, DateTime nowTime)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetAllFullCutPromotion(storeId, nowTime);
            while (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.AddFullCutProduct(pmId, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.DeleteFullCutProductByRecordId(recordIdList);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsExistFullCutProduct(pmId, pid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetFullCutProductList(pageSize, pageNumber, pmId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetFullCutProductCount(pmId);
        }
        ...
        {
            List<StoreProductInfo> storeProductList = new List<StoreProductInfo>();
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetFullCutProductList(pageSize, pageNumber, fullCutPromotionInfo, startPrice, endPrice, sortColumn, sortDirection);
            while (reader.Read())
            {
                StoreProductInfo storeProductInfo = Products.BuildStoreProductFromReader(reader);
                storeProductList.Add(storeProductInfo);
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetFullCutProductCount(fullCutPromotionInfo, startPrice, endPrice);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdListByFullCutProductRecordId(recordIdList);
        }
        ...
        public static List<string> GetFullCutPidList(string recordIdList)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetFullCutPidList(recordIdList);
            while (reader.Read())
            {
