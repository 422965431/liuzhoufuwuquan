...
namespace CouponMall.Data
{
    ...
    public partial class SearchHistories
    {
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateSearchHistory(uid, word, updateTime);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.ClearExpiredSearchHistory();
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetSearchWordStatList(pageSize, pageNumber, word);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetSearchWordStatCount(word);
        }
    }
}
