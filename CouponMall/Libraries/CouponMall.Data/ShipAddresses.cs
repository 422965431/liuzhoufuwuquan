...
namespace CouponMall.Data
{
    ...
    public partial class ShipAddresses
    {
        ...
        {
            int saId = CouponMall.Core.BMAData.RDBS.CreateShipAddress(shipAddressInfo);
            if (_usernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateShipAddress(shipAddressInfo);
            if (_usernosql != null)
                _usernosql.DeleteFullShipAddressList(shipAddressInfo.Uid);
        }
        ...
        public static List<FullShipAddressInfo> GetFullShipAddressList(int uid)
        {
            ...
            if (_usernosql != null)
            {
                ...
                if (fullShipAddressList == null)
                {
                    ...
                    IDataReader reader = CouponMall.Core.BMAData.RDBS.GetFullShipAddressList(uid);
                    while (reader.Read())
                    {
        ...
        public static int GetShipAddressCount(int uid)
        {
            ...
            return CouponMall.Core.BMAData.RDBS.GetShipAddressCount(uid);
        }
        ...
        public static FullShipAddressInfo GetDefaultFullShipAddress(int uid)
        {
            ...
            {
                IDataReader reader = CouponMall.Core.BMAData.RDBS.GetDefaultFullShipAddress(uid);
                if (reader.Read())
                {
        ...
        public static FullShipAddressInfo GetFullShipAddressBySAId(int uid, int saId)
        {
            ...
            {
                IDataReader reader = CouponMall.Core.BMAData.RDBS.GetFullShipAddressBySAId(saId);
                if (reader.Read())
                {
                    fullShipAddressInfo = BuildFullShipAddressFromReader(reader);
                }
        ...
        public static ShipAddressInfo GetShipAddressBySAId(int uid, int saId)
        {
            ...
            {
                IDataReader reader = CouponMall.Core.BMAData.RDBS.GetShipAddressBySAId(saId);
                if (reader.Read())
                {
        ...
        {
            bool result = CouponMall.Core.BMAData.RDBS.DeleteShipAddress(saId, uid);
            if (_usernosql != null)
        ...
        {
            bool result = CouponMall.Core.BMAData.RDBS.UpdateShipAddressIsDefault(saId, uid, isDefault);
            if (_usernosql != null)
