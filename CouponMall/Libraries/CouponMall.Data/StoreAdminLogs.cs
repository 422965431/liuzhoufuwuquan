...
namespace CouponMall.Data
{
    ...
    public partial class StoreAdminLogs
    {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateStoreAdminLog(storeAdminLogInfo);
        }
        ...
        public static List<StoreAdminLogInfo> GetStoreAdminLogList(int pageSize, int pageNumber, string condition)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetStoreAdminLogList(pageSize, pageNumber, condition);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreAdminLogListCondition(storeId, operation, startTime, endTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreAdminLogCount(condition);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteStoreAdminLogById(logIdList);
        }
    }
}
