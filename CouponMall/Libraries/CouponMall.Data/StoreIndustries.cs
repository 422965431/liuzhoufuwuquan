...
namespace CouponMall.Data
{
    ...
    public partial class StoreIndustries
    {
        ...
        public static List<StoreIndustryInfo> GetStoreIndustryList()
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetStoreIndustryList();
            while (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateStoreIndustry(storeIndustryInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateStoreIndustry(storeIndustryInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteStoreIndustryById(storeIid);
        }
    }
}
