...
namespace CouponMall.Data
{
    ...
    public partial class StoreRanks
    {
        ...
        public static List<StoreRankInfo> GetStoreRankList()
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetStoreRankList();
            while (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateStoreRank(storeRankInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteStoreRankById(storeRid);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateStoreRank(storeRankInfo);
        }
    }
}
