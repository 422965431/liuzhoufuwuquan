...
namespace CouponMall.Data
{
    ...
    public partial class Stores
    {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateStoreReview(storeReviewInfo);
        }
        ...
        public static StoreReviewInfo GetStoreReviewByOid(int oid)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetStoreReviewByOid(oid);
            if (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.SumStoreReview(storeId, startTime, endTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.CreateStore(storeInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateStore(storeInfo);
            if (_storenosql != null)
        ...
        public static StoreInfo GetStoreById(int storeId)
        {
            ...
            if (_storenosql != null)
            {
                ...
                if (storeInfo == null)
                {
                    IDataReader reader = CouponMall.Core.BMAData.RDBS.GetStoreById(storeId);
                    if (reader.Read())
                    {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetStoreList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetStoreSelectList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetStoreListCondition(storeName, storeRid, storeIid, state);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetStoreCount(condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdByName(storeName);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetStoreIdByName(storeName);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateStoreState(storeId, state, stateEndTime);
            if (_storenosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateStorePoint(storeId, dePoint, sePoint, shPoint);
            if (_storenosql != null)
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreCountByStoreIid(storeIid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreCountByStoreRid(storeRid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreIdList();
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateStoreKeeper(storeKeeperInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateStoreKeeper(storeKeeperInfo);
            if (_storenosql != null)
        ...
        public static StoreKeeperInfo GetStoreKeeperById(int storeId)
        {
            ...
            if (_storenosql != null)
            {
                ...
                {
                    IDataReader reader = CouponMall.Core.BMAData.RDBS.GetStoreKeeperById(storeId);
                    if (reader.Read())
                    {
        ...
        public static List<StoreClassInfo> GetStoreClassList(int storeId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetStoreClassList(storeId);
            while (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.CreateStoreClass(storeClassInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateStoreClass(storeClassInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteStoreClassById(storeCid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.CreateStoreShipTemplate(storeShipTemplateInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateStoreShipTemplate(storeShipTemplateInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteStoreShipTemplateById(storeSTId);
        }
        ...
        public static StoreShipTemplateInfo GetStoreShipTemplateById(int storeSTId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetStoreShipTemplateById(storeSTId);
            if (reader.Read())
            {
        ...
        public static List<StoreShipTemplateInfo> GetStoreShipTemplateList(int storeId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetStoreShipTemplateList(storeId);
            while (reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateStoreShipFee(storeShipFeeInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateStoreShipFee(storeShipFeeInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteStoreShipFeeById(recordId);
        }
        ...
        public static StoreShipFeeInfo GetStoreShipFeeById(int recordId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetStoreShipFeeById(recordId);
            if (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetStoreShipFeeList(storeSTid);
        }
        ...
        {
            StoreShipFeeInfo storeShipFeeInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetStoreShipFeeByStoreSTidAndRegion(storeSTid, provinceId, cityId);
            if (reader.Read())
            {
                storeShipFeeInfo = BuildStoreShipFeeFromReader(reader);
            }
