...
namespace CouponMall.Data
{
    ...
    public partial class Topics
    {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateTopic(topicInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateTopic(topicInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteTopicById(topicId);
        }
        ...
        public static TopicInfo AdminGetTopicById(int topicId)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.AdminGetTopicById(topicId);
            if (reader.Read())
            {
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetTopicListCondition(sn, title, startTime, endTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetTopicList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetTopicCount(condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.IsExistTopicSN(topicSN);
        }
        ...
        {
            TopicInfo topicInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetTopicByIdAndTime(topicId, nowTime);
            if (reader.Read())
            {
                topicInfo = BuildTopicFromReader(reader);
            }
        ...
        {
            TopicInfo topicInfo = null;
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetTopicBySNAndTime(topicSN, nowTime);
            if (reader.Read())
            {
                topicInfo = BuildTopicFromReader(reader);
            }
