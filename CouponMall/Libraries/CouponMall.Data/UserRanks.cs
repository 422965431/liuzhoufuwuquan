...
namespace CouponMall.Data
{
    ...
    public partial class UserRanks
    {
        ...
        public static List<UserRankInfo> GetUserRankList()
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetUserRankList();
            while(reader.Read())
            {
        ...
        {
            CouponMall.Core.BMAData.RDBS.CreateUserRank(userRankInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.DeleteUserRankById(userRid);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateUserRank(userRankInfo);
        }
    }
}
