...
namespace CouponMall.Data
{
    ...
    public partial class Users
    {
        ...
        public static UserInfo GetUserById(int uid)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetUserById(uid);
            if (reader.Read())
            {
        ...
        public static PartUserInfo GetPartUserById(int uid)
        {
            ...
            if (_usernosql != null)
            {
                ...
                {
                    IDataReader reader = CouponMall.Core.BMAData.RDBS.GetPartUserById(uid);
                    if (reader.Read())
                    {
        ...
        public static UserDetailInfo GetUserDetailById(int uid)
        {
            ...
            if (_usernosql != null)
            {
                ...
                {
                    IDataReader reader = CouponMall.Core.BMAData.RDBS.GetUserDetailById(uid);
                    if (reader.Read())
                    {
        ...
        public static PartUserInfo GetPartUserByName(string userName)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetPartUserByName(userName);
            if (reader.Read())
            {
                partUserInfo = BuildPartUserFromReader(reader);
            }
        ...
        public static PartUserInfo GetPartUserByEmail(string email)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetPartUserByEmail(email);
            if (reader.Read())
            {
                partUserInfo = BuildPartUserFromReader(reader);
            }
        ...
        public static PartUserInfo GetPartUserByMobile(string mobile)
        {
            ...
            IDataReader reader = CouponMall.Core.BMAData.RDBS.GetPartUserByMobile(mobile);
            if (reader.Read())
            {
                partUserInfo = BuildPartUserFromReader(reader);
            }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetUidByUserName(userName);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetUidByEmail(email);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetUidByMobile(mobile);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.CreateUser(userInfo);
        }
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateUser(userInfo);
            if (_usernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdatePartUser(partUserInfo);
            if (_usernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateUserDetail(userDetailInfo);
            if (_usernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateUserLastVisit(uid, visitTime, ip, regionId);
            if (_usernosql != null)
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetUserList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetUserListCondition(userName, email, mobile, userRid, mallAGid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.AdminGetUserCount(condition);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetUserCountByUserRid(userRid);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetUserCountByMallAGid(mallAGid);
        }
        ...
        {
            bool result = CouponMall.Core.BMAData.RDBS.UpdateUser(uid, userName, nickName, avatar, gender, realName, bday, idCard, regionId, address, bio);
            if (_usernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateUserEmailByUid(uid, email);
            if (_usernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateUserMobileByUid(uid, mobile);
            if (_usernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateUserPasswordByUid(uid, password);
            if (_usernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateUserLiftBanTimeByUid(uid, liftBanTime);
            if (_usernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateUserRankByUid(uid, userRid);
            if (_usernosql != null)
        ...
        {
            CouponMall.Core.BMAData.RDBS.UpdateUserOnlineTime(uid, onlineTime, updateTime);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetRegisterTimeByRegisterIP(registerIP);
        }
        ...
        public static DateTime GetUserLastVisitTimeByUid(int uid)
        {
            ...
            {
                return CouponMall.Core.BMAData.RDBS.GetUserLastVisitTimeByUid(uid);
            }
        }
        ...
        public static void SetStoreAdminer(int uid, int storeId)
        {
            ...
            CouponMall.Core.BMAData.RDBS.SetStoreAdminer(uid, storeId);
        }
        ...
        {
            return CouponMall.Core.BMAData.RDBS.GetStoreAdminerIdByStoreId(storeId);
        }
    }
}
