...
namespace CouponMall.Services
{
    ...
    public partial class AdminCategories : Categories
    {
        ...
        public static void UpdateCategory(CategoryInfo categoryInfo, int oldParentId)
        {
            ...
            {
                int changeLayer = 0;
                List<CategoryInfo> categoryList = CouponMall.Data.Categories.GetCategoryList();
                ...
                if (categoryInfo.ParentId > 0)//非顶层分类时
                {
                    ...
                    if (newParentCategoryInfo.HasChild == 0)
                    {
                        ...
                        CouponMall.Data.Categories.UpdateCategory(newParentCategoryInfo);
                    }
                }
                else//顶层分类时
                {
                ...
                if (oldParentId > 0 && categoryList.FindAll(x => x.ParentId == oldParentId).Count == 1)
                {
                    ...
                    CouponMall.Data.Categories.UpdateCategory(oldParentCategoryInfo);
                }
            ...
            CouponMall.Data.Categories.UpdateCategory(categoryInfo);

            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_LIST);
        ...
        public static void CreateCategory(CategoryInfo categoryInfo)
        {
            if (categoryInfo.ParentId > 0)
            {
                ...
                categoryInfo.Path = "";
                int categoryId = CouponMall.Data.Categories.CreateCategory(categoryInfo);
                ...
                if (parentCategoryInfo.HasChild == 0)
                {
                    ...
                    CouponMall.Data.Categories.UpdateCategory(parentCategoryInfo);
                }
            }
            else
            {
        ...
        public static int DeleteCategoryById(int cateId)
        {
            ...
            CouponMall.Data.Categories.DeleteCategoryById(cateId);
            ...
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_LIST);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_BRANDLIST + cateId);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + cateId);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_AANDVLISTJSONCACHE + cateId);
        ...
        {
            CouponMall.Data.Categories.UpdateAttributeGroup(attributeGroupInfo);
        }
        ...
        {
            CouponMall.Data.Categories.CreateAttributeGroup(attributeGroupInfo);
        }
        ...
        public static int DeleteAttributeGroupById(int attrGroupId)
        {
            if (GetAttributeListByAttrGroupId(attrGroupId).Count > 0)
                return 0;
            CouponMall.Data.Categories.DeleteAttributeGroupById(attrGroupId);
            return 1;
        }
        ...
        {
            CouponMall.Data.Categories.UpdateAttribute(attributeInfo);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + attributeInfo.CateId);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + attributeInfo.CateId);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_AANDVLISTJSONCACHE + attributeInfo.CateId);
        }
        ...
        {
            CouponMall.Data.Categories.CreateAttribute(attributeInfo, attributeGroupInfo.AttrGroupId, attributeGroupInfo.Name, attributeGroupInfo.DisplayOrder);
            //CouponMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + attributeInfo.CateId);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_AANDVLISTJSONCACHE + attributeInfo.CateId);
        }
        ...
        public static int DeleteAttributeById(int attrId)
        {
            ...
            CouponMall.Data.Categories.DeleteAttributeById(attrId);
        ...
        {
            return CouponMall.Data.Categories.AdminGetAttributeList(cateId);
        }
        ...
        {
            CouponMall.Data.Categories.CreateAttributeValue(attributeValueInfo);
        ...
        public static int DeleteAttributeValueById(int attrValueId)
        {
            ...
            if (AdminProducts.AdminGetAttrValueProductCount(attrValueId) > 0)
                return 0;
            AttributeInfo attributeInfo = GetAttributeById(attributeValueInfo.AttrId);
            CouponMall.Data.Categories.DeleteAttributeValueById(attrValueId);
            if (attributeInfo.IsFilter == 1)
            {
                CouponMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + attributeInfo.CateId);
            }
        ...
        {
            CouponMall.Data.Categories.UpdateAttributeValue(attributeValueInfo);
            AttributeInfo attributeInfo = GetAttributeById(attributeValueInfo.AttrId);
            if (attributeInfo.IsFilter == 1)
            {
                CouponMall.Core.BMACache.Remove(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + attributeInfo.CateId);
