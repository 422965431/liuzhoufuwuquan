...
namespace CouponMall.Services
{
    ...
    public partial class AdminCoupons : Coupons
    {
        ...
        {
            CouponMall.Data.Coupons.CreateCouponType(couponTypeInfo);
        }
        ...
        public static void DeleteCouponTypeById(int[] couponTypeIdList)
        {
            ...
            {
                //删除优惠劵类型
                CouponMall.Data.Coupons.DeleteCouponTypeById(CommonHelper.IntArrayToString(couponTypeIdList));

                //删除优惠劵类型缓存
                foreach (int couponTypeId in couponTypeIdList)
                {
                    CouponMall.Core.BMACache.Remove(CacheKeys.MALL_COUPONTYPE_INFO + couponTypeId);
                }
            }
        }
        ...
        public static CouponTypeInfo AdminGetCouponTypeById(int couponTypeId)
        {
            ...
            return CouponMall.Data.Coupons.AdminGetCouponTypeById(couponTypeId);
        }
        ...
        {
            return CouponMall.Data.Coupons.AdminGetCouponTypeListCondition(storeId, type, couponTypeName);
        }
        ...
        {
            return CouponMall.Data.Coupons.AdminGetCouponTypeList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.Coupons.AdminGetCouponTypeCount(condition);
        }
        ...
        {
            bool result = CouponMall.Data.Coupons.ChangeCouponTypeState(couponTypeId, state);
            if (result)
            {
                CouponMall.Core.BMACache.Remove(CacheKeys.MALL_COUPONTYPE_INFO + couponTypeId);
            }
        ...
        {
            if (couponTypeIdList != null && couponTypeIdList.Length > 0)
                return CouponMall.Core.BMAData.RDBS.GetStoreIdListByCouponTypeId(CommonHelper.IntArrayToString(couponTypeIdList));
        ...
        {
            return CouponMall.Data.Coupons.AdminGetCouponListCondition(sn, uid, couponTypeId);
        }
        ...
        {
            return CouponMall.Data.Coupons.AdminGetCouponList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.Coupons.AdminGetCouponCount(condition);
        }
        ...
        public static DataTable GetStoreIdListByCouponId(int[] couponIdList)
        {
            if (couponIdList != null && couponIdList.Length > 0)
                return CouponMall.Core.BMAData.RDBS.GetStoreIdListByCouponId(CommonHelper.IntArrayToString(couponIdList));
            return new DataTable();
        }
        ...
        public static void AddCouponProduct(int couponTypeId, int pid)
        {
            if (couponTypeId > 0 && pid > 0)
                CouponMall.Data.Coupons.AddCouponProduct(couponTypeId, pid);
        }
        ...
        public static bool DeleteCouponProductByRecordId(int[] recordIdList)
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return CouponMall.Data.Coupons.DeleteCouponProductByRecordId(CommonHelper.IntArrayToString(recordIdList));
            return false;
        }
        ...
        {
            return CouponMall.Data.Coupons.AdminGetCouponProductList(pageSize, pageNumber, couponTypeId);
        }
        ...
        {
            return CouponMall.Data.Coupons.AdminGetCouponProductCount(couponTypeId);
        }
        ...
        {
            if (recordIdList != null && recordIdList.Length > 0)
                return CouponMall.Core.BMAData.RDBS.GetStoreIdListByCouponProductRecordId(CommonHelper.IntArrayToString(recordIdList));
            return new DataTable();
        }
