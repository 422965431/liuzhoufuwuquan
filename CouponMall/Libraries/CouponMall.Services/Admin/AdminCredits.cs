...
namespace CouponMall.Services
{
    ...
    public partial class AdminCredits : Credits
    {
        ...
        {
            return CouponMall.Data.Credits.AdminGetCreditLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.Credits.AdminGetCreditLogListCondition(uid, startTime, endTime);
        }
        ...
        {
            return CouponMall.Data.Credits.AdminGetCreditLogCount(condition);
        }
        ...
        {
            partUserInfo.UserRid = UserRanks.GetUserRankByCredits(partUserInfo.RankCredits + rankCredits).UserRid;
