...
namespace CouponMall.Services
{
    ...
    public partial class AdminNavs : Navs
    {
        ...
        public static void CreateNav(NavInfo navInfo)
        {
            ...
            CouponMall.Data.Navs.CreateNav(navInfo);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_NAV_LIST);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_NAV_MAINLIST);
        }
        ...
        public static int DeleteNavById(int id)
        {
            ...
            CouponMall.Data.Navs.DeleteNavById(id);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_NAV_LIST);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_NAV_MAINLIST);
            return 1;
        }
        ...
        public static void UpdateNav(NavInfo navInfo, int oldPid)
        {
            ...
            CouponMall.Data.Navs.UpdateNav(navInfo);
