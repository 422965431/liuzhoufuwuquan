...
namespace CouponMall.Services
{
    ...
    public partial class AdminOrderAfterServices : OrderAfterServices
    {
        ...
        {
            CouponMall.Data.OrderAfterServices.CheckOrderAfterService(asId, state, checkResult, checkTime);
        }
        ...
        {
            CouponMall.Data.OrderAfterServices.ReceiveOrderAfterService(asId, OrderAfterServiceState.Received, receiveTime);
        }
        ...
        {
            CouponMall.Data.OrderAfterServices.BackOrderAfterService(asId, OrderAfterServiceState.Backed, shipCoId, shipCoName, shipSN, DateTime.Now);
        }
        ...
        {
            return CouponMall.Data.OrderAfterServices.GetOrderProductAfterServiceList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.OrderAfterServices.GetOrderProductAfterServiceCount(condition);
        }
        ...
        {
            return CouponMall.Data.OrderAfterServices.GetOrderProductAfterServiceListCondition(storeId, uid, oid, state, type, applyStartTime, applyEndTime);
        }
    }
}
