...
namespace CouponMall.Services
{
    ...
    public partial class AdminOrderRefunds : OrderRefunds
    {
        ...
        {
            CouponMall.Data.OrderRefunds.RefundOrder(refundId, state, refundSN, refundTime);
        }
        ...
        {
            return CouponMall.Data.OrderRefunds.GetOrderRefundList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.OrderRefunds.GetOrderRefundListCondition(storeId, osn);
        }
        ...
        {
            return CouponMall.Data.OrderRefunds.GetOrderRefundCount(condition);
        }
    }
}
