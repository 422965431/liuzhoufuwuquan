...
namespace CouponMall.Services
{
    ...
    public partial class AdminOrders : Orders
    {
        ...
        {
            return CouponMall.Data.Orders.GetOrderList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.Orders.GetOrderListCondition(storeId, osn, uid, consignee, orderState);
        }
        ...
        {
            return CouponMall.Data.Orders.GetOrderCount(condition);
        }
        ...
        {
            return CouponMall.Data.Orders.GetSaleProductList(pageSize, pageNumber, storeId, startTime, endTime, orderState);
        }
        ...
        {
            return CouponMall.Data.Orders.GetSaleProductCount(storeId, startTime, endTime, orderState);
        }
        ...
        {
            return CouponMall.Data.Orders.GetOrderStat(statType, storeId, startTime, endTime);
        }
    }
}