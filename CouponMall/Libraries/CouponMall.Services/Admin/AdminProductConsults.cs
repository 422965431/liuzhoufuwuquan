...
namespace CouponMall.Services
{
    ...
    public partial class AdminProductConsults : ProductConsults
    {
        ...
        {
            CouponMall.Data.ProductConsults.CreateProductConsultType(productConsultTypeInfo);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_PRODUCTCONSULTTYPE_LIST);
        }
        ...
        {
            CouponMall.Data.ProductConsults.UpdateProductConsultType(productConsultTypeInfo);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_PRODUCTCONSULTTYPE_LIST);
        }
        ...
        public static int DeleteProductConsultTypeById(int consultTypeId)
        {
            ...
            CouponMall.Data.ProductConsults.DeleteProductConsultTypeById(consultTypeId);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_PRODUCTCONSULTTYPE_LIST);
            return 1;
        }
        ...
        {
            if (consultId > 0)
                return CouponMall.Data.ProductConsults.AdminGetProductConsultById(consultId);
            return null;
        }
        ...
        {
            return CouponMall.Data.ProductConsults.AdminGetProductConsultList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.ProductConsults.AdminGetProductConsultListCondition(consultTypeId, storeId, pid, uid, consultMessage, consultStartTime, consultEndTime);
        }
        ...
        {
            return CouponMall.Data.ProductConsults.AdminGetProductConsultCount(condition);
        }
        ...
        public static DataTable GetStoreIdListByConsultId(int[] consultIdList)
        {
            if (consultIdList != null && consultIdList.Length > 0)
                return CouponMall.Data.ProductConsults.GetStoreIdListByConsultId(CommonHelper.IntArrayToString(consultIdList));
