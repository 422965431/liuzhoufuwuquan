...
namespace CouponMall.Services
{
    ...
    public partial class AdminProductReviews : ProductReviews
    {
        ...
        {
            return CouponMall.Data.ProductReviews.AdminGetProductReviewById(reviewId);
        }
        ...
        {
            if (reviewId > 0)
                CouponMall.Data.ProductReviews.DeleteProductReviewById(reviewId);
        }
        ...
        {
            return CouponMall.Data.ProductReviews.AdminGetProductReviewList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.ProductReviews.AdminGetProductReviewListCondition(storeId, pid, message, startTime, endTime);
        }
        ...
        {
            return CouponMall.Data.ProductReviews.AdminGetProductReviewCount(condition);
        }
        ...
        {
            return CouponMall.Data.ProductReviews.AdminGetProductReviewReplyList(reviewId);
        }
    }
}
