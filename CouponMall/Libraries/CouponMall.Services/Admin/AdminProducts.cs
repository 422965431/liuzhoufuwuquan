...
namespace CouponMall.Services
{
    ...
    public partial class AdminProducts : Products
    {
        ...
        {
            return CouponMall.Data.Products.CreateProduct(productInfo);
        }
        ...
        {
            CouponMall.Data.Products.UpdateProduct(productInfo);
        }
        ...
        {
            return CouponMall.Data.Products.AdminGetProductListCondition(storeId, storeCid, productName, cateId, brandId, state);
        }
        ...
        {
            return CouponMall.Data.Products.AdminGetProductList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.Products.AdminGetProductCount(condition);
        }
        ...
        public static ProductInfo AdminGetProductById(int pid)
        {
            ...
            return CouponMall.Data.Products.AdminGetProductById(pid);
        }
        ...
        {
            if (pid < 1) return null;
            return CouponMall.Data.Products.AdminGetPartProductById(pid);
        }
        ...
        public static void DeleteProductById(int[] pidList)
        {
            if (pidList != null && pidList.Length > 0)
                CouponMall.Data.Products.DeleteProductById(CommonHelper.IntArrayToString(pidList));
        }
        ...
        {
            if (pidList != null && pidList.Length > 0)
                return CouponMall.Data.Products.UpdateProductState(CommonHelper.IntArrayToString(pidList), state);
            return false;
        }
        ...
        public static bool UpdateProductDisplayOrder(int pid, int displayOrder)
        {
            ...
            return CouponMall.Data.Products.UpdateProductDisplayOrder(pid, displayOrder);
        }
        ...
        {
            if (pidList != null && pidList.Length > 0)
                return CouponMall.Data.Products.ChangeProductIsNew(CommonHelper.IntArrayToString(pidList), isNew);
            return false;
        }
        ...
        {
            if (pidList != null && pidList.Length > 0)
                return CouponMall.Data.Products.ChangeProductIsHot(CommonHelper.IntArrayToString(pidList), isHot);
            return false;
        }
        ...
        {
            if (pidList != null && pidList.Length > 0)
                return CouponMall.Data.Products.ChangeProductIsBest(CommonHelper.IntArrayToString(pidList), isBest);
            return false;
        }
        ...
        public static bool UpdateProductShopPrice(int pid, decimal shopPrice)
        {
            ...
            return CouponMall.Data.Products.UpdateProductShopPrice(pid, shopPrice);
        ...
        {
            CouponMall.Data.Products.UpdateProductShowImage(pid, showImg);
        }
        ...
        public static int AdminGetProductIdByName(string name)
        {
            if (string.IsNullOrWhiteSpace(name))
                return -1;
            return CouponMall.Data.Products.AdminGetProductIdByName(name);
        }
        ...
        {
            return CouponMall.Data.Products.AdminGetBrandProductCount(brandId);
        }
        ...
        {
            return CouponMall.Data.Products.AdminGetCategoryProductCount(cateId);
        }
        ...
        {
            return CouponMall.Data.Products.AdminGetAttrValueProductCount(attrValueId);
        }
        ...
        {
            if (pidList != null && pidList.Length > 0)
                return CouponMall.Data.Products.GetStoreIdListByPid(CommonHelper.IntArrayToString(pidList));
        ...
        {
            return CouponMall.Data.Products.AdminGetStoreProductCount(storeId);
        }
        ...
        {
            return CouponMall.Data.Products.AdminGetStoreClassProductCount(storeCid);
        }
        ...
        {
            return CouponMall.Data.Products.AdminGetStoreShipTemplateProductCount(storeSTid);
        }
        ...
        {
            return CouponMall.Data.Products.CreateProductAttribute(productAttributeInfo);
        }
        ...
        public static bool UpdateProductAttribute(ProductAttributeInfo productAttributeInfo)
        {
            if (productAttributeInfo.Pid < 1 || productAttributeInfo.AttrId < 1 || productAttributeInfo.AttrValueId < 0 || (productAttributeInfo.AttrValueId == 0 && string.IsNullOrWhiteSpace(productAttributeInfo.InputValue)))
                return false;
            return CouponMall.Data.Products.UpdateProductAttribute(productAttributeInfo);
        }
        ...
        {
            if (pid > 0 && attrId > 0)
                return CouponMall.Data.Products.DeleteProductAttributeByPidAndAttrId(pid, attrId);
            return false;
        }
        ...
        {
            CouponMall.Data.Products.CreateProductSKUItem(productSKUItemInfo);
        }
        ...
        {
            return CouponMall.Data.Products.IsExistSKUGid(skuGid);
        }
        ...
        public static void DeleteProductImageById(int pImgId)
        {
            ...
            CouponMall.Data.Products.DeleteProductImageById(productImageInfo.Pid, pImgId);
        ...
        public static void SetProductMainImage(int pImgId)
        {
            ...
            {
                CouponMall.Data.Products.SetProductMainImage(productImageInfo.Pid, pImgId);
        ...
        public static void ChangeProductImageDisplayOrder(int pImgId, int displayOrder)
        {
            ...
            if (productImageInfo != null)
                CouponMall.Data.Products.ChangeProductImageDisplayOrder(productImageInfo.Pid, pImgId, displayOrder);
        }
        ...
        {
            CouponMall.Data.Products.CreateProductImage(productImageInfo);
            if (productImageInfo.IsMain == 1)
                UpdateProductShowImage(productImageInfo.Pid, productImageInfo.ShowImg);
        }
        ...
        public static ProductImageInfo GetProductImageById(int pImgId)
        {
            ...
            return CouponMall.Data.Products.GetProductImageById(pImgId);
        }
        ...
        {
            return CouponMall.Data.Products.CreateProductStock(pid, number, limit);
        }
        ...
        {
            CouponMall.Data.Products.UpdateProductStock(pid, number, limit);
        }
        ...
        {
            return CouponMall.Data.Products.UpdateProductStockNumber(pid, number);
        }
        ...
        {
            CouponMall.Data.Products.AddRelateProduct(pid, relatePid);
        }
        ...
        {
            return CouponMall.Data.Products.DeleteRelateProductByPidAndRelatePid(pid, relatePid);
        }
        ...
        {
            return CouponMall.Data.Products.IsExistRelateProduct(pid, relatePid);
        }
        ...
        {
            return CouponMall.Data.Products.AdminGetRelateProductList(pid);
        }
        ...
        {
            return CouponMall.Data.Products.GetTimeProductList(type);
        }
        ...
        {
            return CouponMall.Data.Products.GetTimeProductList(pageSize, pageNumber, storeId, productName);
        }
        ...
        {
            return CouponMall.Data.Products.GetTimeProductCount(storeId, productName);
        }
        ...
        {
            return CouponMall.Data.Products.GetTimeProductByRecordId(recordId);
        }
        ...
        {
            CouponMall.Data.Products.AddTimeProduct(timeProductInfo);
        }
        ...
        {
            CouponMall.Data.Products.UpdateTimeProduct(timeProductInfo);
        }
        ...
        public static bool IsExistTimeProduct(int pid)
        {
            if (pid < 1)
                return false;
            return CouponMall.Data.Products.IsExistTimeProduct(pid);
        }
        ...
        {
            CouponMall.Data.Products.DeleteTimeProductByRecordId(recordId);
        }
    }
}
