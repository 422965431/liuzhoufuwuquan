...
namespace CouponMall.Services
{
    public partial class AdminSearchHistories : SearchHistories
    {
        ...
        {
            return CouponMall.Data.SearchHistories.GetSearchWordStatList(pageSize, pageNumber, word);
        }
        ...
        {
            return CouponMall.Data.SearchHistories.GetSearchWordStatCount(word);
        }
    }
}
