...
namespace CouponMall.Services
{
    ...
    public partial class AdminStoreRanks : StoreRanks
    {
        ...
        {
            CouponMall.Data.StoreRanks.CreateStoreRank(storeRankInfo);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_STORE_RANKLIST);
        }
        ...
        public static int DeleteStoreRankById(int storeRid)
        {
            ...
            if (storeRankInfo != null)
            {
                ...
                CouponMall.Data.StoreRanks.DeleteStoreRankById(storeRid);
                CouponMall.Core.BMACache.Remove(CacheKeys.MALL_STORE_RANKLIST);
                return 1;
            }
            return 0;
        ...
        {
            CouponMall.Data.StoreRanks.UpdateStoreRank(storeRankInfo);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_STORE_RANKLIST);
        }
    }
}
