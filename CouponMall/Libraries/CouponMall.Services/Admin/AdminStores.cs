...
namespace CouponMall.Services
{
    ...
    public partial class AdminStores : Stores
    {
        ...
        {
            int storeId = CouponMall.Data.Stores.CreateStore(storeInfo);
            if (storeId > 0)
            {
        ...
        {
            CouponMall.Data.Stores.UpdateStore(storeInfo);
        }
        ...
        {
            return CouponMall.Data.Stores.AdminGetStoreList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.Stores.AdminGetStoreSelectList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.Stores.AdminGetStoreListCondition(storeName, storeRid, storeIid, state);
        }
        ...
        {
            return CouponMall.Data.Stores.AdminGetStoreCount(condition);
        }
        ...
        {
            return CouponMall.Data.Stores.AdminGetStoreIdByName(storeName);
        }
        ...
        {
            CouponMall.Data.Stores.UpdateStoreState(storeId, state, stateEndTime);
        }
        ...
        {
            return CouponMall.Data.Stores.GetStoreCountByStoreIid(storeIid);
        }
        ...
        {
            return CouponMall.Data.Stores.GetStoreCountByStoreRid(storeRid);
        }
        ...
        {
            CouponMall.Data.Stores.CreateStoreKeeper(storeKeeperInfo);
        }
        ...
        {
            CouponMall.Data.Stores.UpdateStoreKeeper(storeKeeperInfo);
        }
        ...
        public static void CreateStoreClass(StoreClassInfo storeClassInfo)
        {
            ...
            {
                List<StoreClassInfo> storeClassList = CouponMall.Data.Stores.GetStoreClassList(storeClassInfo.StoreId);
                ...
                storeClassInfo.Path = "";
                int storeCid = CouponMall.Data.Stores.CreateStoreClass(storeClassInfo);

                storeClassInfo.StoreCid = storeCid;
                storeClassInfo.Path = parentStoreClassInfo.Path + "," + storeCid;
                CouponMall.Data.Stores.UpdateStoreClass(storeClassInfo);

                if (parentStoreClassInfo.HasChild == 0)
                {
                    parentStoreClassInfo.HasChild = 1;
                    CouponMall.Data.Stores.UpdateStoreClass(parentStoreClassInfo);
                }
            }
            else
            {
            ...
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_STORE_CLASSLIST + storeClassInfo.StoreId);
        }
            ...
            if (storeClassInfo.ParentId != oldParentId)//父分类改变时
            {
                ...
                if (storeClassInfo.ParentId > 0)//非顶层分类时
                {
                    ...
                    if (newParentStoreClassInfo.HasChild == 0)
                    {
                        ...
                        CouponMall.Data.Stores.UpdateStoreClass(newParentStoreClassInfo);
                    }
                }
                else//顶层分类时
                {
                ...
                if (oldParentId > 0 && storeClassList.FindAll(x => x.ParentId == oldParentId).Count == 1)
                {
                    ...
                    CouponMall.Data.Stores.UpdateStoreClass(oldParentStoreClassInfo);
                }
        ...
        {
            List<StoreClassInfo> storeClassList = CouponMall.Data.Stores.GetStoreClassList(storeId);
            ...
            CouponMall.Data.Stores.DeleteStoreClassById(storeCid);
            ...
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_STORE_CLASSLIST + storeId);
            return 1;
        }
        ...
        {
            return CouponMall.Data.Stores.CreateStoreShipTemplate(storeShipTemplateInfo);
        }
        ...
        {
            CouponMall.Data.Stores.UpdateStoreShipTemplate(storeShipTemplateInfo);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_STORE_SHIPTEMPLATEINFO + storeShipTemplateInfo.StoreSTid);
        }
        ...
        public static int DeleteStoreShipTemplateById(int storeSTid)
        {
            ...
            if (AdminProducts.AdminGetStoreShipTemplateProductCount(storeSTid) > 0)
                return -1;
            CouponMall.Data.Stores.DeleteStoreShipTemplateById(storeSTid);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_STORE_SHIPTEMPLATEINFO + storeSTid);
            return 1;
        }
        ...
        {
            return CouponMall.Data.Stores.GetStoreShipTemplateList(storeId);
        }
        ...
        {
            CouponMall.Data.Stores.CreateStoreShipFee(storeShipFeeInfo);
        }
        ...
        {
            CouponMall.Data.Stores.UpdateStoreShipFee(storeShipFeeInfo);
        }
        ...
        {
            CouponMall.Data.Stores.DeleteStoreShipFeeById(recordId);
        }
        ...
        {
            return CouponMall.Data.Stores.GetStoreShipFeeById(recordId);
        }
        ...
        {
            return CouponMall.Data.Stores.AdminGetStoreShipFeeList(storeSTid);
        }
    }
}
