...
namespace CouponMall.Services
{
    ...
    public partial class AdminTopic : Topics
    {
        ...
        {
            CouponMall.Data.Topics.CreateTopic(topicInfo);
        }
        ...
        {
            CouponMall.Data.Topics.UpdateTopic(topicInfo);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_TOPIC_INFO + topicInfo.TopicId);
            CouponMall.Core.BMACache.Remove(CacheKeys.MALL_TOPIC_INFO + topicInfo.SN);
        }
        ...
        public static void DeleteTopicById(int topicId)
        {
            ...
            if (topicInfo != null)
            {
                CouponMall.Data.Topics.DeleteTopicById(topicId);
                CouponMall.Core.BMACache.Remove(CacheKeys.MALL_TOPIC_INFO + topicInfo.TopicId);
                CouponMall.Core.BMACache.Remove(CacheKeys.MALL_TOPIC_INFO + topicInfo.SN);
            }
        }
        ...
        {
            if (topicId > 0)
                return CouponMall.Data.Topics.AdminGetTopicById(topicId);
            return null;
        }
        ...
        {
            return CouponMall.Data.Topics.AdminGetTopicListCondition(sn, title, startTime, endTime);
        }
        ...
        {
            return CouponMall.Data.Topics.AdminGetTopicList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.Topics.AdminGetTopicCount(condition);
        }
    }
}
