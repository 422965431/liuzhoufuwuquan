...
namespace CouponMall.Services
{
    ...
    public partial class AdminUserRanks : UserRanks
    {
        ...
        {
            CouponMall.Data.UserRanks.CreateUserRank(userRankInfo);
        ...
        public static int DeleteUserRankById(int userRid)
        {
            ...
            if (userRankInfo != null)
            {
                ...
                CouponMall.Data.UserRanks.DeleteUserRankById(userRid);
                BMACache.Remove(CacheKeys.MALL_USERRANK_LIST);
                return 1;
            }
            return 0;
        ...
        {
            CouponMall.Data.UserRanks.UpdateUserRank(userRankInfo);
            BMACache.Remove(CacheKeys.MALL_USERRANK_LIST);
        }
    }
}
