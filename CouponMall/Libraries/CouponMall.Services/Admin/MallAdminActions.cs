...
namespace CouponMall.Services
{
    public partial class MallAdminActions
    {
        ...
        {
            return CouponMall.Data.MallAdminActions.GetMallAdminActionList();
        }
        ...
        {
            HashSet<string> actionHashSet = CouponMall.Core.BMACache.Get(CacheKeys.MALL_MALLADMINACTION_HASHSET) as HashSet<string>;
            if (actionHashSet == null)
            {
                ...
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_MALLADMINACTION_HASHSET, actionHashSet);
            }
