...
namespace CouponMall.Services
{
    ...
    public partial class MallAdminLogs
    {
        ...
        public static void CreateMallAdminLog(int uid, string nickName, int mallAGid, string mallAGTitle, string ip, string operation, string description)
        {
            ...
            CouponMall.Data.MallAdminLogs.CreateMallAdminLog(adminOperateLogInfo);
        }
        ...
        {
            return CouponMall.Data.MallAdminLogs.GetMallAdminLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.MallAdminLogs.GetMallAdminLogListCondition(uid, operation, startTime, endTime);
        }
        ...
        {
            return CouponMall.Data.MallAdminLogs.GetMallAdminLogCount(condition);
        }
        ...
        public static void DeleteMallAdminLogById(int[] logIdList)
        {
            if (logIdList != null && logIdList.Length > 0)
                CouponMall.Data.MallAdminLogs.DeleteMallAdminLogById(CommonHelper.IntArrayToString(logIdList));
        }
    }
}
