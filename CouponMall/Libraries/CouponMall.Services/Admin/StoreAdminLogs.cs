...
namespace CouponMall.Services
{
    ...
    public partial class StoreAdminLogs
    {
        ...
        public static void CreateStoreAdminLog(int uid, string nickName, int storeId, string storeName, string ip, string operation, string description)
        {
            ...
            CouponMall.Data.StoreAdminLogs.CreateStoreAdminLog(storeAdminLogInfo);
        }
        ...
        {
            return CouponMall.Data.StoreAdminLogs.GetStoreAdminLogList(pageSize, pageNumber, condition);
        }
        ...
        {
            return CouponMall.Data.StoreAdminLogs.GetStoreAdminLogListCondition(storeId, operation, startTime, endTime);
        }
        ...
        {
            return CouponMall.Data.StoreAdminLogs.GetStoreAdminLogCount(condition);
        }
        ...
        public static void DeleteStoreAdminLogById(int[] logIdList)
        {
            if (logIdList != null && logIdList.Length > 0)
                CouponMall.Data.StoreAdminLogs.DeleteStoreAdminLogById(CommonHelper.IntArrayToString(logIdList));
        }
    }
}
