...
namespace CouponMall.Services
{
    ...
    public partial class BannedIPs
    {
        ...
        {
            HashSet<string> ipList = CouponMall.Core.BMACache.Get(CacheKeys.MALL_BANNEDIP_HASHSET) as HashSet<string>;
            if (ipList == null)
            {
                ipList = CouponMall.Data.BannedIPs.GetBannedIPList();
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_BANNEDIP_HASHSET, ipList);
            }
            return ipList;
        }
        ...
        {
            return CouponMall.Data.BannedIPs.GetBannedIPById(id);
        }
        ...
        public static int GetBannedIPIdByIP(string ip)
        {
            if (string.IsNullOrWhiteSpace(ip))
                return 0;
            return CouponMall.Data.BannedIPs.GetBannedIPIdByIP(ip);
        }
    }
}
