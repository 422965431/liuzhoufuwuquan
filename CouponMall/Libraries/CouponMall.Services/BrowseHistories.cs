...
namespace CouponMall.Services
{
    ...
    public partial class BrowseHistories
    {
        ...
        {
            int broHisCount = BMAConfig.MallConfig.BroHisCount;
            if (broHisCount > 0)
            {
                ...
                else
                {
                    ...
                    if (uid > 0)
                    {
                        List<PartProductInfo> userBrowseProductList = GetUserBrowseProductList(BMAConfig.MallConfig.BroHisCount + 1, 1, uid);
                        StringBuilder sb = new StringBuilder();
        ...
        {
            return CouponMall.Data.BrowseHistories.GetUserBrowseProductList(pageSize, pageNumber, uid);
        }
        ...
        {
            return CouponMall.Data.BrowseHistories.GetUserBrowseProductCount(uid);
        }
        ...
        public static void UpdateBrowseHistory(object state)
        {
            ...
            CouponMall.Data.BrowseHistories.UpdateBrowseHistory(updateBrowseHistoryState.Uid, updateBrowseHistoryState.Pid, updateBrowseHistoryState.UpdateTime);
        }
        ...
        {
            CouponMall.Data.BrowseHistories.ClearExpiredBrowseHistory();
        }
    }
}
