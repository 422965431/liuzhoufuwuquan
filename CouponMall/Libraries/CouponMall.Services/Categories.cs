...
namespace CouponMall.Services
{
    ...
    public partial class Categories
    {
        ...
        {
            List<CategoryInfo> categoryList = CouponMall.Core.BMACache.Get(CacheKeys.MALL_CATEGORY_LIST) as List<CategoryInfo>;
            if (categoryList == null)
            {
                categoryList = new List<CategoryInfo>();
                List<CategoryInfo> sourceCategoryList = CouponMall.Data.Categories.GetCategoryList();
                CreateCategoryTree(sourceCategoryList, categoryList, 0);
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_CATEGORY_LIST, categoryList);
            }
            return categoryList;
        }
        ...
        {
            List<BrandInfo> brandList = CouponMall.Core.BMACache.Get(CacheKeys.MALL_CATEGORY_BRANDLIST + cateId) as List<BrandInfo>;
            if (brandList == null)
            {
                brandList = CouponMall.Data.Categories.GetCategoryBrandList(cateId);
                if (brandList != null)
                    CouponMall.Core.BMACache.Insert(CacheKeys.MALL_CATEGORY_BRANDLIST + cateId, brandList);
            }
        ...
        {
            List<KeyValuePair<AttributeInfo, List<AttributeValueInfo>>> itemList = CouponMall.Core.BMACache.Get(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + cateId) as List<KeyValuePair<AttributeInfo, List<AttributeValueInfo>>>;
            if (itemList == null)
            {
                ...
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_CATEGORY_FILTERAANDVLIST + cateId, itemList);
            }
        ...
        {
            string jsonCache = CouponMall.Core.BMACache.Get(CacheKeys.MALL_CATEGORY_AANDVLISTJSONCACHE + cateId) as string;
            if (jsonCache == null)
            {
                ...
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_CATEGORY_AANDVLISTJSONCACHE + cateId, jsonCache);
            }
        ...
        {
            return CouponMall.Data.Categories.GetAttributeGroupListByCateId(cateId);
        }
        ...
        {
            return CouponMall.Data.Categories.GetAttributeGroupById(attrGroupId);
        }
        ...
        public static int GetAttributeGroupIdByCateIdAndName(int cateId, string name)
        {
            if (cateId < 1 || string.IsNullOrWhiteSpace(name))
                return 0;
            return CouponMall.Data.Categories.GetAttrGroupIdByCateIdAndName(cateId, name);
        }
        ...
        {
            return CouponMall.Data.Categories.GetAttributeById(attrId);
        }
        ...
        public static int GetAttrIdByCateIdAndName(int cateId, string attributeName)
        {
            if (cateId < 1 || string.IsNullOrWhiteSpace(attributeName))
                return 0;
            return CouponMall.Data.Categories.GetAttrIdByCateIdAndName(cateId, attributeName);
        }
        ...
        {
            return CouponMall.Data.Categories.GetAttributeListByCateId(cateId);
        }
        ...
        {
            return CouponMall.Data.Categories.GetAttributeListByAttrGroupId(attrGroupId);
        }
        ...
        {
            return CouponMall.Data.Categories.GetFilterAttributeListByCateId(cateId);
        }
        ...
        {
            return CouponMall.Data.Categories.GetAttributeValueListByAttrId(attrId);
        }
        ...
        {
            return CouponMall.Data.Categories.GetAttributeValueById(attrValueId);
        }
        ...
        public static int GetAttributeValueIdByAttrIdAndValue(int attrId, string attrValue)
        {
            if (attrId < 1 || string.IsNullOrWhiteSpace(attrValue))
                return 0;
            return CouponMall.Data.Categories.GetAttributeValueIdByAttrIdAndValue(attrId, attrValue);
        }
    }
}
