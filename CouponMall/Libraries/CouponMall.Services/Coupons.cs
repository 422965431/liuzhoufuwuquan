...
namespace CouponMall.Services
{
    ...
    public partial class Coupons
    {
        ...
        {
            CouponTypeInfo couponTypeInfo = CouponMall.Core.BMACache.Get(CacheKeys.MALL_COUPONTYPE_INFO + couponTypeId) as CouponTypeInfo;
            if (couponTypeInfo == null)
            {
                couponTypeInfo = CouponMall.Data.Coupons.GetCouponTypeById(couponTypeId);
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_COUPONTYPE_INFO + couponTypeId, couponTypeInfo);
            }
        ...
        {
            return CouponMall.Data.Coupons.GetSendingPromotionCouponTypeList(storeId);
        }
        ...
        {
            return CouponMall.Data.Coupons.GetSendingCouponTypeList(storeId, nowTime);
        }
        ...
        {
            return CouponMall.Data.Coupons.GetUsingCouponTypeList(storeId, nowTime);
        }
        ...
        {
            CouponMall.Data.Coupons.CreateCoupon(couponInfo);
        }
        ...
        public static void DeleteCouponById(int[] idList)
        {
            if (idList != null && idList.Length > 0)
                CouponMall.Data.Coupons.DeleteCouponById(CommonHelper.IntArrayToString(idList));
        }
        ...
        {
            CouponMall.Data.Coupons.DeleteCouponById(idList);
        }
        ...
        {
            return CouponMall.Data.Coupons.IsExistCouponSN(couponSN);
        }
        ...
        {
            return CouponMall.Data.Coupons.GetSendCouponCount(couponTypeId);
        }
        ...
        {
            return CouponMall.Data.Coupons.GetSendUserCouponCount(uid, couponTypeId);
        }
        ...
        {
            return CouponMall.Data.Coupons.GetTodaySendUserCouponCount(uid, couponTypeId, today);
        }
        ...
        {
            return CouponMall.Data.Coupons.GetCouponList(uid, 0);
        }
        ...
        {
            DataTable dt = CouponMall.Data.Coupons.GetCouponList(uid, 1);
            if (dt.Rows.Count < 1)
                return dt;
        ...
        {
            return CouponMall.Data.Coupons.GetCouponList(uid, 2);
        }
        ...
        {
            return CouponMall.Data.Coupons.GetCouponByCouponId(couponId);
        }
        ...
        {
            return CouponMall.Data.Coupons.GetCouponByCouponSN(couponSN);
        }
        ...
        {
            CouponMall.Data.Coupons.UseCoupon(couponId, oid, time, ip);
        }
        ...
        {
            CouponMall.Data.Coupons.ActivateAndUseCoupon(couponId, uid, oid, time, ip);
        }
        ...
        {
            CouponMall.Data.Coupons.ActivateCoupon(couponId, uid, time, ip);
        }
        ...
        {
            CouponMall.Data.Coupons.ReturnUserOrderUseCoupons(oid);
        }
        ...
        {
            return CouponMall.Data.Coupons.GetUserOrderSendCouponList(oid);
        }
        ...
        {
            return CouponMall.Data.Coupons.IsExistCouponProduct(couponTypeId, pid);
        }
        ...
        {
            return CouponMall.Data.Coupons.IsSameCouponType(couponTypeId, pidList);
        }
    }
}
