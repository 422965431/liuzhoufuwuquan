...
namespace CouponMall.Services
{
    ...
    public partial class FavoriteProducts
    {
        ...
        {
            return CouponMall.Data.FavoriteProducts.AddProductToFavorite(uid, pid, state, addTime);
        }
        ...
        {
            return CouponMall.Data.FavoriteProducts.DeleteFavoriteProductByUidAndPid(uid, pid);
        }
        ...
        {
            return CouponMall.Data.FavoriteProducts.IsExistFavoriteProduct(uid, pid);
        }
        ...
        {
            return CouponMall.Data.FavoriteProducts.GetFavoriteProductList(pageSize, pageNumber, uid, storeName, productName);
        }
        ...
        {
            return CouponMall.Data.FavoriteProducts.GetFavoriteProductList(pageSize, pageNumber, uid);
        }
        ...
        {
            return CouponMall.Data.FavoriteProducts.GetFavoriteProductCount(uid, storeName, productName);
        }
        ...
        {
            return CouponMall.Data.FavoriteProducts.GetFavoriteProductCount(uid);
        }
        ...
        {
            return CouponMall.Data.FavoriteProducts.SetFavoriteProductState(uid, pid, state);
        }
    }
}
