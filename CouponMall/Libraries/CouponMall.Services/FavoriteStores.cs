...
namespace CouponMall.Services
{
    ...
    public partial class FavoriteStores
    {
        ...
        {
            return CouponMall.Data.FavoriteStores.AddStoreToFavorite(uid, storeId, addTime);
        }
        ...
        {
            return CouponMall.Data.FavoriteStores.DeleteFavoriteStoreByUidAndStoreId(uid, storeId);
        }
        ...
        {
            return CouponMall.Data.FavoriteStores.IsExistFavoriteStore(uid, storeId);
        }
        ...
        {
            return CouponMall.Data.FavoriteStores.GetFavoriteStoreList(pageSize, pageNumber, uid);
        }
        ...
        {
            return CouponMall.Data.FavoriteStores.GetFavoriteStoreCount(uid);
        }
    }
}
