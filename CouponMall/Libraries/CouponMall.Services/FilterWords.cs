...
namespace CouponMall.Services
{
    ...
    public partial class FilterWords
    {
        ...
        static FilterWords()
        {
            string[] wordList = StringHelper.SplitString(BMAConfig.MallConfig.IgnoreWords, "\n");
        ...
        {
            return CouponMall.Data.FilterWords.GetFilterWordList();
        }
        ...
        {
            object[,] filterWordRegexList = CouponMall.Core.BMACache.Get(CacheKeys.MALL_FILTERWORD_REGEXLIST) as object[,];
            if (filterWordRegexList == null)
            {
                ...
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_FILTERWORD_REGEXLIST, filterWordRegexList);
            }
