...
namespace CouponMall.Services
{
    ...
    public partial class LoginFailLogs
    {
        ...
        {
            LoginFailLogInfo loginFailLogInfo = CouponMall.Data.LoginFailLogs.GetLoginFailLogByIP(CommonHelper.ConvertIPToLong(loginIP));
        ...
        {
            CouponMall.Data.LoginFailLogs.AddLoginFailTimes(CommonHelper.ConvertIPToLong(loginIP), loginTime);
        }
        ...
        {
            CouponMall.Data.LoginFailLogs.DeleteLoginFailLogByIP(CommonHelper.ConvertIPToLong(loginIP));
        }
    }
}
