    ...
    public partial class OAuths
    {
        ...
        public static UserInfo CreateOAuthUser(string oUserName, string uNamePrefix, string openId, string server, int regionId)
        {
            ...
            if (uid > 0)
            {
                ...
                CouponMall.Data.OAuths.CreateOAuthUser(oauthInfo);
            }
            else
            {
                userInfo = null;
        ...
        public static int GetUidByOpenIdAndServer(string openId, string server)
        {
            if (string.IsNullOrWhiteSpace(openId) || string.IsNullOrWhiteSpace(server))
                return -1;
            return CouponMall.Data.OAuths.GetUidByOpenIdAndServer(openId, server);
        }
        ...
        {
            return CouponMall.Data.OAuths.GetOAuthUserByUid(uid);
        }
        ...
        {
            return CouponMall.Data.OAuths.GetOAuthUserList(CommonHelper.IntArrayToString(uidList));
        }
