...
namespace CouponMall.Services
{
    ...
    public partial class OnlineUsers
    {
        ...
        public static int CreateOnlineMember(int uid, string sid, string nickName, DateTime updateTime, string ip, int regionId)
        {
            ...
            int olid = CouponMall.Data.OnlineUsers.CreateOnlineUser(onlineUserInfo);
        ...
        public static int CreateOnlineGuest(string sid, DateTime updateTime, string ip, int regionId)
        {
            ...
            return CouponMall.Data.OnlineUsers.CreateOnlineUser(onlineUserInfo);
        }
        ...
        {
            CouponMall.Data.OnlineUsers.UpdateOnlineUserIP(olId, ip);
        }
        ...
        {
            CouponMall.Data.OnlineUsers.UpdateOnlineUserUid(olId, uid);
        }
        ...
        {
            return CouponMall.Data.OnlineUsers.GetOnlineUserBySid(sid);
        }
        ...
        {
            return CouponMall.Data.OnlineUsers.GetOnlineUserCount(userType);
        }
        ...
        public static int GetOnlineUserCount()
        {
            ...
            int onlineAllUserCount = TypeHelper.ObjectToInt(CouponMall.Core.BMACache.Get(CacheKeys.MALL_ONLINEUSER_ALLUSERCOUNT), -1);
            if (onlineAllUserCount == -1)
            {
                onlineAllUserCount = GetOnlineUserCount(0);
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_ONLINEUSER_ALLUSERCOUNT, onlineAllUserCount);
            }
        ...
        public static int GetOnlineGuestCount()
        {
            ...
            int onlineGuestCount = TypeHelper.ObjectToInt(CouponMall.Core.BMACache.Get(CacheKeys.MALL_ONLINEUSER_GUESTCOUNT), -1);
            if (onlineGuestCount == -1)
            {
                onlineGuestCount = GetOnlineUserCount(-1);
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_ONLINEUSER_GUESTCOUNT, onlineGuestCount);
            }
        ...
        {
            CouponMall.Data.OnlineUsers.DeleteOnlineUserBySid(sid);
        }
        ...
        public static void DeleteExpiredOnlineUser()
        {
            ...
            {
                CouponMall.Data.OnlineUsers.DeleteExpiredOnlineUser(BMAConfig.MallConfig.OnlineUserExpire);
        ...
        public static void ResetOnlineUserTable()
        {
            try
            {
                CouponMall.Data.OnlineUsers.ResetOnlineUserTable();
            }
            catch
            {
                try
        ...
        {
            return CouponMall.Data.OnlineUsers.GetOnlineUserList(pageSize, pageNumber, locationType, locationId);
        }
        ...
        {
            return CouponMall.Data.OnlineUsers.GetOnlineUserCount(locationType, locationId);
        }
    }
}
