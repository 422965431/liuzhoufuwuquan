...
namespace CouponMall.Services
{
    ...
    public partial class OrderActions
    {
        ...
        {
            CouponMall.Data.OrderActions.CreateOrderAction(orderActionInfo);
        }
        ...
        {
            return CouponMall.Data.OrderActions.GetOrderActionList(oid);
        }
        ...
        {
            return CouponMall.Data.OrderActions.GetOrderIdList(startTime, endTime, orderActionType);
        }
    }
}
