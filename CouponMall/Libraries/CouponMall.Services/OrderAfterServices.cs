...
namespace CouponMall.Services
{
    ...
    public partial class OrderAfterServices
    {
        ...
        {
            CouponMall.Data.OrderAfterServices.ApplyOrderAfterService(OrderAfterServiceState.Checking, uid, oid, recordId, pid, cateId, brandId, storeId, pname, pshowImg, count, money, type, applyReason, applyTime);
        }
        ...
        {
            CouponMall.Data.OrderAfterServices.SendOrderAfterService(asId, OrderAfterServiceState.Sended, shipCoId, shipCoName, shipSN, regionId, consignee, mobile, phone, email, zipCode, address, sendTime);
        }
        ...
        {
            CouponMall.Data.OrderAfterServices.CompleteOrderAfterService(asId, OrderAfterServiceState.Completed);
        }
        ...
        {
            return CouponMall.Data.OrderAfterServices.GetOrderAfterServiceList(oid);
        }
        ...
        {
            return CouponMall.Data.OrderAfterServices.GetOrderProductAfterServiceList(recordId);
        }
        ...
        {
            return CouponMall.Data.OrderAfterServices.GetOrderAfterServiceByASId(asId);
        }
    }
}
