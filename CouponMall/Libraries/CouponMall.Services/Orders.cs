...
namespace CouponMall.Services
{
    ...
    public partial class Orders
    {
        ...
        {
            if (oid > 0)
                return CouponMall.Data.Orders.GetOrderByOid(oid);
            else
                return null;
        }
        ...
        public static OrderInfo GetOrderByOSN(string osn)
        {
            if (!string.IsNullOrWhiteSpace(osn))
                return CouponMall.Data.Orders.GetOrderByOSN(osn);
            return null;
        }
        ...
        {
            return CouponMall.Data.Orders.GetOrderCountByCondition(storeId, orderState, startTime, endTime);
        }
        ...
        {
            return CouponMall.Data.Orders.GetOrderProductList(oid);
        }
        ...
        public static List<OrderProductInfo> GetOrderProductList(string oidList)
        {
            if (!string.IsNullOrEmpty(oidList))
                return CouponMall.Data.Orders.GetOrderProductList(oidList);
        ...
        {
            CouponMall.Data.Orders.UpdateOrderDiscount(oid, discount, surplusMoney);
        }
        ...
        {
            CouponMall.Data.Orders.UpdateOrderShipFee(oid, shipFee, orderAmount, surplusMoney);
        }
        ...
        {
            CouponMall.Data.Orders.PayOrder(oid, orderState, paySN, paySystemName, payFriendName, payTime);
        }
        ...
        {
            CouponMall.Data.Orders.SendOrderProduct(oid, orderState, shipSN, shipCoId, shipCoName, shipTime);
        }
        ...
        {
            CouponMall.Data.Orders.UpdateOrderState(oid, orderState);
        }
        ...
        {
            CouponMall.Data.Orders.UpdateOrderIsReview(oid, isReview);
        }
        ...
        {
            CouponMall.Data.Orders.ClearExpiredOnlinePayOrder(expireTime);
        }
        ...
        {
            CouponMall.Data.Orders.AutoReceiveOrder(expireTime);
        }
        ...
        {
            return CouponMall.Data.Orders.GetUserOrderList(uid, pageSize, pageNumber, startAddTime, endAddTime, orderState);
        }
        ...
        {
            return CouponMall.Data.Orders.GetUserOrderCount(uid, startAddTime, endAddTime, orderState);
        }
        ...
        {
            return CouponMall.Data.Orders.GetUserUnReviewOrderList(uid, pageSize, pageNumber, startAddTime, endAddTime);
        }
        ...
        {
            return CouponMall.Data.Orders.GetUserUnReviewOrderCount(uid, startAddTime, endAddTime);
        }
