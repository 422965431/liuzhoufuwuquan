...
namespace CouponMall.Services
{
    ...
    public partial class PVStats
    {
        ...
        {
            CouponMall.Data.PVStats.UpdatePVStat((UpdatePVStatState)updatePVStatState);
        }
        ...
        {
            return CouponMall.Data.PVStats.GetProvinceRegionStat(storeId);
        }
        ...
        {
            return CouponMall.Data.PVStats.GetCityRegionStat(storeId, provinceId);
        }
        ...
        {
            return CouponMall.Data.PVStats.GetCountyRegionStat(storeId, cityId);
        }
        ...
        {
            return CouponMall.Data.PVStats.GetPVStatList(condition);
        }
        ...
        {
            return CouponMall.Data.PVStats.GetPVStatByCategoryAndValue(category, value);
        }
