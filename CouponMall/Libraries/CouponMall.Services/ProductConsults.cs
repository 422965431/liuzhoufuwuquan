...
namespace CouponMall.Services
{
    ...
    public partial class ProductConsults
    {
        ...
        {
            ProductConsultTypeInfo[] productConsultTypeList = CouponMall.Core.BMACache.Get(CacheKeys.MALL_PRODUCTCONSULTTYPE_LIST) as ProductConsultTypeInfo[];
            if (productConsultTypeList == null)
            {
                productConsultTypeList = CouponMall.Data.ProductConsults.GetProductConsultTypeList();
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_PRODUCTCONSULTTYPE_LIST, productConsultTypeList);
            }
        ...
        {
            CouponMall.Data.ProductConsults.ConsultProduct(pid, consultTypeId, consultUid, storeId, consultTime, consultMessage, consultNickName, pName, pShowImg, consultIP);
        }
        ...
        {
            CouponMall.Data.ProductConsults.ReplyProductConsult(consultId, replyUid, replyTime, replyMessage, replyNickName, replyIP);
        }
        ...
        {
            if (consultId > 0)
                return CouponMall.Data.ProductConsults.GetProductConsultById(consultId);
            return null;
        }
        ...
        public static void DeleteProductConsultById(int[] consultIdList)
        {
            if (consultIdList != null && consultIdList.Length > 0)
                CouponMall.Data.ProductConsults.DeleteProductConsultById(CommonHelper.IntArrayToString(consultIdList));
        }
        ...
        public static bool UpdateProductConsultState(int consultId, int state)
        {
            if (consultId > 0 && (state == 0 || state == 1))
                return CouponMall.Data.ProductConsults.UpdateProductConsultState(consultId, state);
            return false;
        }
        ...
        {
            return CouponMall.Data.ProductConsults.GetProductConsultList(pageSize, pageNumber, pid, consultTypeId, consultMessage);
        }
        ...
        {
            return CouponMall.Data.ProductConsults.GetProductConsultCount(pid, consultTypeId, consultMessage);
        }
        ...
        {
            return CouponMall.Data.ProductConsults.GetUserProductConsultList(uid, pageSize, pageNumber);
        }
        ...
        {
            return CouponMall.Data.ProductConsults.GetUserProductConsultCount(uid);
        }
    }
}
