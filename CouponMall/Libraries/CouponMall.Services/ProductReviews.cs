...
namespace CouponMall.Services
{
    ...
    public partial class ProductReviews
    {
        ...
        {
            return CouponMall.Data.ProductReviews.GetProductReviewById(reviewId);
        }
        ...
        {
            CouponMall.Data.ProductReviews.ReviewProduct(productReviewInfo);
        }
        ...
        {
            CouponMall.Data.ProductReviews.VoteProductReview(reviewId, uid, voteTime);
        }
        ...
        {
            return CouponMall.Data.ProductReviews.IsVoteProductReview(reviewId, uid);
        }
        ...
        public static bool ChangeProductReviewState(int reviewId, int state)
        {
            if (reviewId > 0 && (state == 0 || state == 1))
                return CouponMall.Data.ProductReviews.ChangeProductReviewState(reviewId, state);
            return false;
        }
        ...
        {
            return CouponMall.Data.ProductReviews.GetUserProductReviewList(uid, pageSize, pageNumber);
        }
        ...
        {
            return CouponMall.Data.ProductReviews.GetUserProductReviewCount(uid);
        }
        ...
        {
            return CouponMall.Data.ProductReviews.GetProductReviewList(pid, type, pageSize, pageNumber);
        }
        ...
        {
            return CouponMall.Data.ProductReviews.GetProductReviewCount(pid, type);
        }
        ...
        {
            return CouponMall.Data.ProductReviews.GetProductReviewWithReplyById(reviewId);
        }
        ...
        {
            return CouponMall.Data.ProductReviews.GetProductReviewList(startTime, endTime);
        }
    }
}
