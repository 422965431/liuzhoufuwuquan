...
namespace CouponMall.Services
{
    ...
    public partial class Products
    {
        ...
        public static ProductInfo GetProductById(int pid)
        {
            ...
            return CouponMall.Data.Products.GetProductById(pid);
        }
        ...
        {
            if (pid < 1) return null;
            return CouponMall.Data.Products.GetPartProductById(pid);
        }
        ...
        public static List<PartProductInfo> GetPartProductList(string pidList)
        {
            ...
            return CouponMall.Data.Products.GetPartProductList(pidList);
        }
        ...
        {
            return CouponMall.Data.Products.GetProductShadowVisitCountById(pid);
        }
        ...
        {
            CouponMall.Data.Products.UpdateProductShadowVisitCount(pid, visitCount);
        }
        ...
        {
            CouponMall.Data.Products.AddProductShadowSaleCount(pid, saleCount);
        }
        ...
        {
            CouponMall.Data.Products.AddProductShadowReviewCount(pid, starType);
        }
        ...
        {
            return CouponMall.Data.Products.GetCategoryProductList(pageSize, pageNumber, cateId, brandId, filterPrice, catePriceRangeList, attrValueIdList, onlyStock, sortColumn, sortDirection);
        }
        ...
        {
            return CouponMall.Data.Products.GetCategoryProductCount(cateId, brandId, filterPrice, catePriceRangeList, attrValueIdList, onlyStock);
        }
        ...
        {
            return CouponMall.Data.Products.GetStoreClassProductList(pageSize, pageNumber, storeCid, startPrice, endPrice, sortColumn, sortDirection);
        }
        ...
        {
            return CouponMall.Data.Products.GetStoreClassProductCount(storeCid, startPrice, endPrice);
        }
        ...
        {
            List<PartProductInfo> storeTraitProductList = CouponMall.Core.BMACache.Get(string.Format(CacheKeys.MALL_PRODUCT_STORETRAITLIST, count, storeId, storeCid, trait)) as List<PartProductInfo>;
            if (storeTraitProductList == null)
            {
                storeTraitProductList = CouponMall.Data.Products.GetStoreTraitProductList(count, storeId, storeCid, trait);
                CouponMall.Core.BMACache.Insert(string.Format(CacheKeys.MALL_PRODUCT_STORETRAITLIST, count, storeId, storeCid, trait), storeTraitProductList);
            }
        ...
        {
            List<PartProductInfo> storeSaleProductList = CouponMall.Core.BMACache.Get(string.Format(CacheKeys.MALL_PRODUCT_STORESALELIST, count, storeId, storeCid)) as List<PartProductInfo>;
            if (storeSaleProductList == null)
            {
                storeSaleProductList = CouponMall.Data.Products.GetStoreSaleProductList(count, storeId, storeCid);
                CouponMall.Core.BMACache.Insert(string.Format(CacheKeys.MALL_PRODUCT_STORESALELIST, count, storeId, storeCid), storeSaleProductList);
            }
        ...
        {
            return CouponMall.Data.Products.GetProductSummaryList(pidList);
        }
        ...
        {
            return CouponMall.Data.Products.GetProductAttributeByPidAndAttrId(pid, attrId);
        }
        ...
        {
            return CouponMall.Data.Products.GetProductAttributeList(pid);
        }
        ...
        {
            return CouponMall.Data.Products.GetExtProductAttributeList(pid);
        }
        ...
        {
            return CouponMall.Data.Products.GetProductSKUItemList(pid);
        }
        ...
        {
            if (skuGid > 0)
                return CouponMall.Data.Products.GetProductSKUListBySKUGid(skuGid);
        ...
        {
            if (pid > 0)
                return CouponMall.Data.Products.GetProductImageList(pid);
        ...
        {
            return CouponMall.Data.Products.GetProductStockByPid(pid);
        }
        ...
        {
            return CouponMall.Data.Products.GetProductStockNumberByPid(pid);
        }
        ...
        {
            CouponMall.Data.Products.IncreaseProductStockNumber(orderProductList);
        }
        ...
        {
            CouponMall.Data.Products.DecreaseProductStockNumber(orderProductList);
        }
        ...
        {
            if (!string.IsNullOrEmpty(pidList))
                return CouponMall.Data.Products.GetProductStockList(pidList);
        ...
        {
            return CouponMall.Data.Products.GetRelateProductList(pid);
        }
    }
}
