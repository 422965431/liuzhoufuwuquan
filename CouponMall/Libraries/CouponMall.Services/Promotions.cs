...
namespace CouponMall.Services
{
    ...
    public partial class Promotions
    {
        ...
        {
            return CouponMall.Data.Promotions.GetSinglePromotionByPidAndTime(pid, nowTime);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetSinglePromotionProductBuyCount(uid, pmId);
        }
        ...
        {
            CouponMall.Data.Promotions.UpdateSinglePromotionStock(singlePromotionList);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetBuySendPromotionList(storeId, pid, nowTime);
        }
        ...
        {
            return CouponMall.Data.Promotions.IsExistBuySendProduct(pmId, pid);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetAllBuySendPromotion(storeId, nowTime);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetGiftPromotionByPidAndTime(pid, buyTime);
        }
        ...
        {
            return CouponMall.Data.Promotions.IsExistGift(pmId, giftId);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetExtGiftList(pmId);
        }
        ...
        {
            if (pmId > 0)
                return CouponMall.Data.Promotions.GetSuitPromotionByPmIdAndTime(pmId, nowTime);
            return null;
        }
        ...
        {
            return CouponMall.Data.Promotions.IsJoinSuitPromotion(uid, pmId);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetSuitPromotionList(pid, nowTime);
        }
        ...
        {
            return CouponMall.Data.Promotions.IsExistSuitProduct(pmId, pid);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetExtSuitProductList(pmId);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetAllExtSuitProductList(pmIdList);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetFullSendPromotionByStoreIdAndPidAndTime(storeId, pid, nowTime);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetFullSendPromotionByPmIdAndTime(pmId, nowTime);
        }
        ...
        {
            return CouponMall.Data.Promotions.IsExistFullSendProduct(pmId, pid);
        }
        ...
        {
            return CouponMall.Data.Promotions.IsExistFullSendProduct(pmId, pid, type);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetFullSendMainProductList(pageSize, pageNumber, pmId, startPrice, endPrice, sortColumn, sortDirection);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetFullSendMainProductCount(pmId, startPrice, endPrice);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetFullSendPresentList(pmId);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetFullCutPromotionByStoreIdAndPidAndTime(storeId, pid, nowTime);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetFullCutPromotionByStoreIdAndPmIdAndTime(storeId, pmId, nowTime);
        }
        ...
        {
            if (pmId > 0 && pid > 0)
                return CouponMall.Data.Promotions.IsExistFullCutProduct(pmId, pid);
            return false;
        }
        ...
        {
            return CouponMall.Data.Promotions.GetAllFullCutPromotion(storeId, nowTime);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetFullCutProductList(pageSize, pageNumber, fullCutPromotionInfo, startPrice, endPrice, sortColumn, sortDirection);
        }
        ...
        {
            return CouponMall.Data.Promotions.GetFullCutProductCount(fullCutPromotionInfo, startPrice, endPrice);
        }
