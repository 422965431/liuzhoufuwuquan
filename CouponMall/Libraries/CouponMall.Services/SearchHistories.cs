...
namespace CouponMall.Services
{
    ...
    public partial class SearchHistories
    {
        ...
        public static void UpdateSearchHistory(object state)
        {
            ...
            CouponMall.Data.SearchHistories.UpdateSearchHistory(updateSearchHistoryState.Uid, updateSearchHistoryState.Word, updateSearchHistoryState.UpdateTime);
        }
        ...
        {
            CouponMall.Data.SearchHistories.ClearExpiredSearchHistory();
        }
    }
}
