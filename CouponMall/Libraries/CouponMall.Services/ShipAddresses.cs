...
namespace CouponMall.Services
{
    ...
    public partial class ShipAddresses
    {
        ...
        {
            return CouponMall.Data.ShipAddresses.CreateShipAddress(shipAddressInfo);
        }
        ...
        {
            CouponMall.Data.ShipAddresses.UpdateShipAddress(shipAddressInfo);
        }
        ...
        {
            return CouponMall.Data.ShipAddresses.GetFullShipAddressList(uid);
        }
        ...
        {
            return CouponMall.Data.ShipAddresses.GetShipAddressCount(uid);
        }
        ...
        {
            return CouponMall.Data.ShipAddresses.GetDefaultFullShipAddress(uid);
        }
        ...
        public static FullShipAddressInfo GetFullShipAddressBySAId(int saId, int uid)
        {
            ...
            FullShipAddressInfo fullShipAddressInfo = CouponMall.Data.ShipAddresses.GetFullShipAddressBySAId(uid, saId);
        ...
        public static ShipAddressInfo GetShipAddressBySAId(int saId, int uid)
        {
            ...
            ShipAddressInfo shipAddressInfo = CouponMall.Data.ShipAddresses.GetShipAddressBySAId(uid, saId);
        ...
        public static bool DeleteShipAddress(int saId, int uid)
        {
            if (saId < 1)
                return false;
            return CouponMall.Data.ShipAddresses.DeleteShipAddress(saId, uid);
        }
        ...
        public static bool UpdateShipAddressIsDefault(int saId, int uid, int isDefault)
        {
            ...
            return CouponMall.Data.ShipAddresses.UpdateShipAddressIsDefault(saId, uid, isDefault);
        }
    }
}
