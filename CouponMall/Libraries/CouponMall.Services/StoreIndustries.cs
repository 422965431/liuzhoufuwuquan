...
namespace CouponMall.Services
{
    ...
    public partial class StoreIndustries
    {
        ...
        {
            List<StoreIndustryInfo> storeIndustryList = CouponMall.Core.BMACache.Get(CacheKeys.MALL_STORE_INDUSTRYLIST) as List<StoreIndustryInfo>;
            if (storeIndustryList == null)
            {
                storeIndustryList = CouponMall.Data.StoreIndustries.GetStoreIndustryList();
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_STORE_INDUSTRYLIST, storeIndustryList);
            }
