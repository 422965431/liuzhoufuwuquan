...
namespace CouponMall.Services
{
    ...
    public partial class StoreRanks
    {
        ...
        {
            List<StoreRankInfo> storeRankList = CouponMall.Core.BMACache.Get(CacheKeys.MALL_STORE_RANKLIST) as List<StoreRankInfo>;
            if (storeRankList == null)
            {
                storeRankList = CouponMall.Data.StoreRanks.GetStoreRankList();
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_STORE_RANKLIST, storeRankList);
            }
