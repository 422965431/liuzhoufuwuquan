...
namespace CouponMall.Services
{
    ...
    public partial class Stores
    {
        ...
        {
            CouponMall.Data.Stores.CreateStoreReview(storeReviewInfo);
        }
        ...
        {
            return CouponMall.Data.Stores.GetStoreReviewByOid(oid);
        }
        ...
        {
            return CouponMall.Data.Stores.SumStoreReview(storeId, startTime, endTime);
        }
        ...
        public static StoreInfo GetStoreById(int storeId)
        {
            ...
            return CouponMall.Data.Stores.GetStoreById(storeId);
        }
        ...
        public static int GetStoreIdByName(string storeName)
        {
            if (string.IsNullOrWhiteSpace(storeName))
                return 0;
            return CouponMall.Data.Stores.GetStoreIdByName(storeName);
        }
        ...
        {
            CouponMall.Data.Stores.UpdateStorePoint(storeId, dePoint, sePoint, shPoint);
        }
        ...
        {
            return CouponMall.Data.Stores.GetStoreIdList();
        }
        ...
        {
            return CouponMall.Data.Stores.GetStoreKeeperById(storeId);
        }
        ...
        {
            List<StoreClassInfo> storeClassList = CouponMall.Core.BMACache.Get(CacheKeys.MALL_STORE_CLASSLIST + storeId) as List<StoreClassInfo>;
            if (storeClassList == null)
            {
                storeClassList = new List<StoreClassInfo>();
                List<StoreClassInfo> sourceStoreClassList = CouponMall.Data.Stores.GetStoreClassList(storeId);
                CreateStoreClassTree(sourceStoreClassList, storeClassList, 0);
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_STORE_CLASSLIST + storeId, storeClassList);
            }
        ...
        {
            StoreShipTemplateInfo storeShipTemplateInfo = CouponMall.Core.BMACache.Get(CacheKeys.MALL_STORE_SHIPTEMPLATEINFO + storeSTid) as StoreShipTemplateInfo;
            if (storeShipTemplateInfo == null)
            {
                storeShipTemplateInfo = CouponMall.Data.Stores.GetStoreShipTemplateById(storeSTid);
                CouponMall.Core.BMACache.Insert(CacheKeys.MALL_STORE_SHIPTEMPLATEINFO + storeSTid, storeShipTemplateInfo);
            }
        ...
        {
            return CouponMall.Data.Stores.GetStoreShipFeeByStoreSTidAndRegion(storeSTId, provinceId, cityId);
        }
    }
}
