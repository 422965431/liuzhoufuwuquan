...
namespace CouponMall.Services
{
    ...
    public partial class Users
    {
        ...
        {
            if (uid > 0)
                return CouponMall.Data.Users.GetPartUserById(uid);
        ...
        {
            if (uid > 0)
                return CouponMall.Data.Users.GetUserById(uid);
        ...
        {
            if (uid > 0)
                return CouponMall.Data.Users.GetUserDetailById(uid);
        ...
        {
            return CouponMall.Data.Users.GetPartUserByName(userName);
        }
        ...
        {
            return CouponMall.Data.Users.GetPartUserByEmail(email);
        }
        ...
        {
            return CouponMall.Data.Users.GetPartUserByMobile(mobile);
        }
        ...
        public static int GetUidByUserName(string userName)
        {
            ...
            return CouponMall.Data.Users.GetUidByUserName(userName);
        }
        ...
        public static int GetUidByEmail(string email)
        {
            ...
            return CouponMall.Data.Users.GetUidByEmail(email);
        }
        ...
        public static int GetUidByMobile(string mobile)
        {
            ...
            return CouponMall.Data.Users.GetUidByMobile(mobile);
        }
        ...
        {
            return CouponMall.Data.Users.CreateUser(userInfo);
        }
        ...
        {
            CouponMall.Data.Users.UpdateUser(userInfo);
        }
        ...
        {
            CouponMall.Data.Users.UpdatePartUser(partUserInfo);
        }
        ...
        {
            CouponMall.Data.Users.UpdateUserDetail(userDetailInfo);
        }
        ...
        {
            CouponMall.Data.Users.UpdateUserLastVisit(uid, visitTime, ip, regionId);
        }
        ...
        {
            return CouponMall.Data.Users.GetUserCountByUserRid(userRid);
        }
        ...
        {
            return CouponMall.Data.Users.GetUserCountByMallAGid(mallAGid);
        }
        ...
        {
            return CouponMall.Data.Users.UpdateUser(uid, userName, nickName, avatar, gender, realName, bday, idCard, regionId, address, bio);
        }
        ...
        {
            CouponMall.Data.Users.UpdateUserEmailByUid(uid, email);
        }
        ...
        {
            CouponMall.Data.Users.UpdateUserMobileByUid(uid, mobile);
        }
        ...
        {
            CouponMall.Data.Users.UpdateUserPasswordByUid(uid, password);
        }
        ...
        {
            CouponMall.Data.Users.UpdateUserLiftBanTimeByUid(uid, liftBanTime);
        }
        ...
        {
            CouponMall.Data.Users.UpdateUserRankByUid(uid, userRid);
        }
        ...
        public static void UpdateUserOnlineTime(int uid)
        {
            ...
            {
                CouponMall.Data.Users.UpdateUserOnlineTime(uid, updateOnlineTimeSpan, DateTime.Now);
        ...
        {
            return CouponMall.Data.Users.GetRegisterTimeByRegisterIP(registerIP);
        }
        ...
        {
            return CouponMall.Data.Users.GetUserLastVisitTimeByUid(uid);
        }
        ...
        {
            return CouponMall.Data.Users.GetStoreAdminerIdByStoreId(storeId);
        }
    }
}
