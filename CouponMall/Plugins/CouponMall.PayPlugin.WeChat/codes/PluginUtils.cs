...
namespace CouponMall.PayPlugin.WeChat
{
    /// <summary>
    /// 插件工具类
    /// </summary>
    public class PluginUtils
    {
        ...
        private static string _dbfilepath = "/plugins/CouponMall.PayPlugin.WeChat/db.config";//数据文件路径
        ...
        public static void SavePluginSet(PluginSetInfo pluginSetInfo)
        {
            lock (_locker)
            {
                ...
                _pluginsetinfo = null;
                PayConfig.ReSet();
                CouponMall.PayPlugin.OpenWeChat.PayConfig.ReSet();
            }
        }
    }
