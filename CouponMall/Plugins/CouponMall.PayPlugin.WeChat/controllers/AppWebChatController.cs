...
using CouponMall.PayPlugin.OpenWeChat;

namespace CouponMall.Web.App.Controllers
{
    /// <summary>
    /// App微信支付控制器类
    /// </summary>
    public class WeChatController : Controller
    {
        ...
        public ActionResult Pay()
        {
            ...
            //服务器异步通知页面路径
            string notifyUrl = string.Format("http://{0}/app/wechat/notify", BMAConfig.MallConfig.SiteUrl);
