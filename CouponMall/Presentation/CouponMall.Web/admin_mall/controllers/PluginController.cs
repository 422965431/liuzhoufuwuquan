...
namespace CouponMall.Web.MallAdmin.Controllers
{
    ...
    /// 商城后台插件控制器类
    /// </summary>
    public partial class PluginController : BaseMallAdminController
    {
        /// <summary>
        /// 插件列表
        /// </summary>
        ...
        public ActionResult Install(string systemName)
        {
            ...
            AddMallAdminLog("安装插件", "安装插件,插件为:" + systemName);
        ...
        public ActionResult Uninstall(string systemName)
        {
            ...
            AddMallAdminLog("卸载插件", "卸载插件,插件为:" + systemName);
        ...
        public ActionResult Default(string systemName)
        {
            ...
            AddMallAdminLog("设置默认插件", "设置默认插件,插件为:" + systemName);
