...
namespace CouponMall.Web.StoreAdmin.Controllers
{
    ...
    /// 店铺后台促销活动控制器类
    /// </summary>
    public partial class PromotionController : BaseStoreAdminController
    {
        /// <summary>
        /// 单品促销活动列表
        /// </summary>
        ...
        public ActionResult SinglePromotionList(string productName, string promotionName, string promotionTime, int pid = -1, int pageSize = 15, int pageNumber = 1)
        {
            string condition = AdminPromotions.AdminGetSinglePromotionListCondition(WorkContext.StoreId, pid, promotionName, promotionTime);
            ...
            MallUtils.SetAdminRefererCookie(string.Format("{0}?pageNumber={1}&pageSize={2}&pid={3}&productName={4}&promotionName={5}&promotionTime={6}",
        ...
        public ActionResult EditSinglePromotion(int pmId = -1)
        {
            ...
            if (singlePromotionInfo.StoreId != WorkContext.StoreId)
        ...
        public ActionResult EditSinglePromotion(SinglePromotionModel model, int pmId = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                AddStoreAdminLog("修改单品促销", "修改单品促销,单品促销ID为:" + pmId);
        ...
        {
            if (!AdminPromotions.IsStorePromotionBySinglePmId(WorkContext.StoreId, pmIdList))
                return PromptView("不能删除其它店铺的单品促销活动");

            AdminPromotions.DeleteSinglePromotionById(pmIdList);
            AddStoreAdminLog("删除单品促销", "删除单品促销,单品促销ID为:" + CommonHelper.IntArrayToString(pmIdList));
        ...
        private void LoadSinglePromotion()
        {
            ...
            foreach (CouponTypeInfo couponTypeInfo in AdminCoupons.GetSendingPromotionCouponTypeList(WorkContext.StoreId))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult BuySendPromotionList(string promotionName, string promotionTime, int pageSize = 15, int pageNumber = 1)
        {
            string condition = AdminPromotions.AdminGetBuySendPromotionListCondition(WorkContext.StoreId, promotionName, promotionTime);
            ...
            MallUtils.SetAdminRefererCookie(string.Format("{0}?pageNumber={1}&pageSize={2}&promotionName={3}&promotionTime={4}",
        ...
        public ActionResult AddBuySendPromotion(BuySendPromotionModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                AddStoreAdminLog("添加买送促销", "添加买送促销,买送促销为:" + model.PromotionName);
        ...
        public ActionResult EditBuySendPromotion(int pmId = -1)
        {
            ...
            if (buySendPromotionInfo.StoreId != WorkContext.StoreId)
                return PromptView("不能操作其它店铺的促销活动");
        ...
        public ActionResult EditBuySendPromotion(BuySendPromotionModel model, int pmId = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                AddStoreAdminLog("修改买送促销", "修改买送促销,买送促销ID为:" + pmId);
        ...
        {
            if (!AdminPromotions.IsStorePromotionByBuySendPmId(WorkContext.StoreId, pmIdList))
                return PromptView("不能删除其它店铺的买送促销活动");

            AdminPromotions.DeleteBuySendPromotionById(pmIdList);
            AddStoreAdminLog("删除买送促销", "删除买送促销,买送促销ID为:" + CommonHelper.IntArrayToString(pmIdList));
        ...
        public ActionResult AddBuySendProduct(int pmId = -1, int pid = 1)
        {
            ...
            if (buySendPromotionInfo == null)
                return PromptView("买送促销不存在");
            if (buySendPromotionInfo.Type == 0)
            ...
            AddStoreAdminLog("添加买送商品", "添加买送商品,商品为:" + partProductInfo.Name);
        ...
        {
            if (!AdminPromotions.IsStoreBuySendProductByBuySendProductRecordId(WorkContext.StoreId, new int[] { recordId }))
                return Content("0");

            bool result = AdminPromotions.DeleteBuySendProductByRecordId(new[] { recordId });
            if (result)
            {
                AddStoreAdminLog("删除买送商品", "删除买送商品,商品ID:" + recordId);
                return Content("1");
            }
            else
            {
        ...
        {
            if (!AdminPromotions.IsStoreBuySendProductByBuySendProductRecordId(WorkContext.StoreId, recordIdList))
                return PromptView("不能删除其它店铺的买送商品");

            AdminPromotions.DeleteBuySendProductByRecordId(recordIdList);
            AddStoreAdminLog("删除买送商品", "删除买送商品,商品ID:" + CommonHelper.IntArrayToString(recordIdList));
        ...
        /// <param name="promotionTime">活动时间</param>
        /// <param name="pid">商品id</param>
        public ActionResult GiftPromotionList(string productName, string promotionName, string promotionTime, int pid = -1, int pageSize = 15, int pageNumber = 1)
        {
            string condition = AdminPromotions.AdminGetGiftPromotionListCondition(WorkContext.StoreId, pid, promotionName, promotionTime);
        ...
        public ActionResult AddGiftPromotion(GiftPromotionModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                AddStoreAdminLog("添加赠品促销活动", "添加赠品促销活动,赠品促销活动为:" + model.PromotionName);
        ...
        public ActionResult EditGiftPromotion(int pmId = -1)
        {
            ...
            if (giftPromotionInfo.StoreId != WorkContext.StoreId)
                return PromptView("不能操作其它店铺的促销活动");
        ...
        public ActionResult EditGiftPromotion(GiftPromotionModel model, int pmId = -1)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                AddStoreAdminLog("修改赠品促销活动", "修改赠品促销活动,赠品促销活动ID为:" + pmId);
        ...
        {
            if (!AdminPromotions.IsStorePromotionByGiftPmId(WorkContext.StoreId, pmIdList))
                return PromptView("不能删除其它店铺的赠品促销活动");

            AdminPromotions.DeleteGiftPromotionById(pmIdList);
            AddStoreAdminLog("删除赠品促销活动", "删除赠品促销活动,赠品促销活动ID为:" + CommonHelper.IntArrayToString(pmIdList));
        ...
        public ActionResult AddGift(int pmId = -1, int giftId = -1, int number = -1)
        {
            ...
            AddStoreAdminLog("添加赠品", "添加赠品,赠品为:" + partProductInfo.Name);
        ...
        {
            GiftPromotionInfo giftPromotionInfo = AdminPromotions.AdminGetGiftPromotionById(pmId);
            if (giftPromotionInfo == null || giftPromotionInfo.StoreId != WorkContext.StoreId)
                return Content("0");

            bool result = AdminPromotions.UpdateGiftNumber(pmId, giftId, number);
            if (result)
            {
                AddStoreAdminLog("修改赠品数量", "修改赠品" + pmId + "_" + giftId + "数量,数量为:" + number);
                return Content("1");
            }
            else
            {
        ...
        public ActionResult DelGift(int pmId = -1, int giftId = -1)
        {
            ...
            if (result)
            {
                AddStoreAdminLog("删除赠品", "删除赠品,赠品ID为" + pmId + "_" + giftId);
                return Content("1");
            }
            else
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult SuitPromotionList(string productName, string promotionName, string promotionTime, int pid = -1, int pageSize = 15, int pageNumber = 1)
        {
            string condition = AdminPromotions.AdminGetSuitPromotionListCondition(WorkContext.StoreId, pid, promotionName, promotionTime);
        ...
        {
            if (!AdminPromotions.IsStorePromotionBySuitPmId(WorkContext.StoreId, pmIdList))
                return PromptView("不能删除其它店铺的套装促销活动");

            AdminPromotions.DeleteSuitPromotionById(pmIdList);
            AddStoreAdminLog("删除套装促销活动", "删除套装促销活动,套装促销活动ID为:" + CommonHelper.IntArrayToString(pmIdList));
        ...
        public ActionResult AddSuitProduct(int pmId = -1, int pid = -1, int discount = -1, int number = 1)
        {
            ...
            AddStoreAdminLog("添加套装商品", "添加套装商品,套装商品为:" + partProductInfo.Name);
        ...
        {
            SuitPromotionInfo suitPromotionInfo = AdminPromotions.AdminGetSuitPromotionById(pmId);
            if (suitPromotionInfo == null || suitPromotionInfo.StoreId != WorkContext.StoreId)
                return Content("0");

            bool result = AdminPromotions.UpdateSuitProductNumber(pmId, pid, number);
            if (result)
            {
                AddStoreAdminLog("修改套装商品数量", "修改套装商品数量,数量为:" + number);
                return Content("1");
            }
            else
            {
        ...
        public ActionResult UpdateSuitProductDiscountValue(int pmId = -1, int pid = -1, int discount = 0)
        {
            ...
            if (result)
            {
                AddStoreAdminLog("修改套装商品折扣", "修改套装商品折扣,折扣为:" + discount);
                return Content("1");
            }
            else
            {
        ...
        public ActionResult DelSuitProduct(int pmId = -1, int pid = -1)
        {
            ...
            if (result)
            {
                AddStoreAdminLog("删除套装商品", "删除套装商品,套装商品ID为" + pmId + "_" + pid);
                return Content("1");
            }
            else
            {
        ...
        /// 满赠促销活动列表
        /// </summary>
        public ActionResult FullSendPromotionList(string promotionName, string promotionTime, int pageSize = 15, int pageNumber = 1)
        {
            string condition = AdminPromotions.AdminGetFullSendPromotionListCondition(WorkContext.StoreId, promotionName, promotionTime);
        ...
        {
            if (!AdminPromotions.IsStorePromotionByFullSendPmId(WorkContext.StoreId, pmIdList))
                return PromptView("不能删除其它店铺的满赠促销活动");

            AdminPromotions.DeleteFullSendPromotionById(pmIdList);
            AddStoreAdminLog("删除满赠促销活动", "删除满赠促销活动,满赠促销活动ID为:" + CommonHelper.IntArrayToString(pmIdList));
        ...
        public ActionResult AddFullSendProduct(int pmId = -1, int pid = -1, int type = 0)
        {
            ...
            AddStoreAdminLog("添加满赠商品", "添加满赠商品,满赠商品为:" + partProductInfo.Name);
        ...
        {
            if (!AdminPromotions.IsStoreFullSendProductByFullSendProductRecordId(WorkContext.StoreId, new int[] { recordId }))
                return Content("0");

            bool result = AdminPromotions.DeleteFullSendProductByRecordId(new[] { recordId });
            if (result)
            {
                AddStoreAdminLog("删除满赠商品", "删除满赠商品,商品ID:" + recordId);
                return Content("1");
            }
            else
            {
        ...
        {
            if (!AdminPromotions.IsStoreFullSendProductByFullSendProductRecordId(WorkContext.StoreId, recordIdList))
                return PromptView("不能删除其它店铺的满赠促销活动");

            AdminPromotions.DeleteFullSendProductByRecordId(recordIdList);
            AddStoreAdminLog("删除满赠商品", "删除满赠商品,商品ID:" + CommonHelper.IntArrayToString(recordIdList));
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult FullCutPromotionList(string promotionName, string promotionTime, int pageSize = 15, int pageNumber = 1)
        {
            string condition = AdminPromotions.AdminGetFullCutPromotionListCondition(WorkContext.StoreId, promotionName, promotionTime);
        ...
        {
            if (!AdminPromotions.IsStorePromotionByFullCutPmId(WorkContext.StoreId, pmIdList))
                return PromptView("不能删除其它店铺的满减促销活动");

            AdminPromotions.DeleteFullCutPromotionById(pmIdList);
            AddStoreAdminLog("删除满减促销活动", "删除满减促销活动,满减促销活动ID为:" + CommonHelper.IntArrayToString(pmIdList));
        ...
        public ActionResult AddFullCutProduct(int pmId = -1, int pid = -1, int type = 0)
        {
            ...
            AddStoreAdminLog("添加满减商品", "添加满减商品,满减商品为:" + partProductInfo.Name);
        ...
        {
            if (!AdminPromotions.IsStoreFullCutProductByFullCutProductRecordId(WorkContext.StoreId, new int[] { recordId }))
                return Content("0");

            bool result = AdminPromotions.DeleteFullCutProductByRecordId(new[] { recordId });
            if (result)
            {
                AddStoreAdminLog("删除满减商品", "删除满减商品,商品ID:" + recordId);
                return Content("1");
            }
            else
            {
        ...
        {
            if (!AdminPromotions.IsStoreFullCutProductByFullCutProductRecordId(WorkContext.StoreId, recordIdList))
                return PromptView("不能删除其它店铺的满减促销活动");

            AdminPromotions.DeleteFullCutProductByRecordId(recordIdList);
            AddStoreAdminLog("删除满减商品", "删除满减商品,商品ID:" + CommonHelper.IntArrayToString(recordIdList));
