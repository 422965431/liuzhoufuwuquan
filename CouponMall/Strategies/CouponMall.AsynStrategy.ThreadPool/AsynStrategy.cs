...
namespace CouponMall.AsynStrategy.ThreadPool
{
    /// <summary>
    /// 基于Stephen Toub线程池的异步策略
    /// </summary>
    public partial class AsynStrategy : IAsynStrategy
    {
        ...
        /// </summary>
        /// <param name="state">state</param>
        public void UpdateBrowseHistory(UpdateBrowseHistoryState state)
        {
            ManagedThreadPool.QueueUserWorkItem(new WaitCallback(BrowseHistories.UpdateBrowseHistory), state);
        }
        ...
        /// </summary>
        /// <param name="state">state</param>
        public void UpdateSearchHistory(UpdateSearchHistoryState state)
        {
            ManagedThreadPool.QueueUserWorkItem(new WaitCallback(SearchHistories.UpdateSearchHistory), state);
        }
