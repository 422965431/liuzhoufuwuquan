...
namespace CouponMall.RDBSStrategy.SqlServer
{
    ...
    internal partial class TableFields
    {
        ...
        /// 订单退款表
        /// </summary>
        public const string ORDER_REFUNDS = "[refundid],[state],[storeid],[storename],[oid],[osn],[uid],[asid],[paysystemname],[payfriendname],[paysn],[paymoney],[refundmoney],[applytime],[refundsn],[refundtime]";
